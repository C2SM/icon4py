...
rm ${DYCORE_GT4PY_PROGRAMS_TIMER_FILE} output.csv || true

echo "Running dycore benchmark using GT4Py cache directory: ${GT4PY_BUILD_CACHE_DIR}"
...
python amd_scripts/print_gt4py_timers.py ${DYCORE_GT4PY_PROGRAMS_TIMER_FILE} --csv
cat output.csv
