...
export GT4PY_BUILD_CACHE_DIR=gh200_profiling_thetarho_regional
...
ncu --set full ${NCU_KERNEL_NAME_FILTER} --import-source yes -f -o thetarho .venv/bin/python -m pytest -sv \
    -m continuous_benchmarking \
    -p no:tach \
    --backend=dace_gpu \
    --grid=${ICON_GRID} \
