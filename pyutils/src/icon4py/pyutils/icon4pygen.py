...
@click.argument("fencil_import_path", type=str)
...
def main(
    ...
    Args:
        fencil_import_path: may be specified as <module>:<member>, where <module> is the dotted name of the containing module
