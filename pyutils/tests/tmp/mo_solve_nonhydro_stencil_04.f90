...
module mo_solve_nonhydro_stencil_04
   use, intrinsic :: iso_c_binding
   implicit none
   interface
      subroutine &
         run_mo_solve_nonhydro_stencil_04( &
         wgtfacq_c, &
         z_exner_ex_pr, &
         z_exner_ic, &
         vertical_lower, &
      ...
      subroutine &
         run_and_verify_mo_solve_nonhydro_stencil_04( &
         wgtfacq_c, &
         z_exner_ex_pr, &
         z_exner_ic, &
         z_exner_ic_before, &
      ...
      subroutine &
         setup_mo_solve_nonhydro_stencil_04( &
         mesh, &
         k_size, &
         stream, &
         z_exner_ic_kmax &
      ...
      subroutine &
         free_mo_solve_nonhydro_stencil_04() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_solve_nonhydro_stencil_04( &
      wgtfacq_c, &
      z_exner_ex_pr, &
      z_exner_ic, &
      z_exner_ic_before, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_solve_nonhydro_stencil_04 &
         ( &
         wgtfacq_c, &
         z_exner_ex_pr, &
         z_exner_ic, &
...
#else
      call run_mo_solve_nonhydro_stencil_04 &
         ( &
         wgtfacq_c, &
         z_exner_ex_pr, &
         z_exner_ic, &
   ...
   subroutine &
      wrap_setup_mo_solve_nonhydro_stencil_04( &
      mesh, &
      k_size, &
      stream, &
      z_exner_ic_kmax &
      ...
      call setup_mo_solve_nonhydro_stencil_04 &
         ( &
         mesh, &
         k_size, &
         stream, &
