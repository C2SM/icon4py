...
module mo_velocity_advection_stencil_05
   ...
   interface
      ...
      subroutine &
         run_and_verify_mo_velocity_advection_stencil_05( &
         vn, &
         vt, &
         vn_ie, &
         z_vt_ie, &
      ...
      subroutine &
         setup_mo_velocity_advection_stencil_05( &
         mesh, &
         k_size, &
         stream, &
         vn_ie_kmax, &
      ...
      subroutine &
         free_mo_velocity_advection_stencil_05() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_velocity_advection_stencil_05 &
         ( &
         vn, &
         vt, &
         vn_ie, &
...
#else
      call run_mo_velocity_advection_stencil_05 &
         ( &
         vn, &
         vt, &
         vn_ie, &
   ...
   subroutine &
      wrap_setup_mo_velocity_advection_stencil_05( &
      mesh, &
      k_size, &
      stream, &
      vn_ie_kmax, &
      ...
      call setup_mo_velocity_advection_stencil_05 &
         ( &
         mesh, &
         k_size, &
         stream, &
