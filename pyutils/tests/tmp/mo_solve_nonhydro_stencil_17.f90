...
module mo_solve_nonhydro_stencil_17
   use, intrinsic :: iso_c_binding
   implicit none
   interface
      subroutine &
         run_mo_solve_nonhydro_stencil_17( &
         hmask_dd3d, &
         scalfac_dd3d, &
      ...
      subroutine &
         run_and_verify_mo_solve_nonhydro_stencil_17( &
         hmask_dd3d, &
         scalfac_dd3d, &
         inv_dual_edge_length, &
         z_dwdz_dd, &
      ...
      subroutine &
         setup_mo_solve_nonhydro_stencil_17( &
         mesh, &
         k_size, &
         stream, &
         z_graddiv_vn_kmax &
      ...
      subroutine &
         free_mo_solve_nonhydro_stencil_17() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_solve_nonhydro_stencil_17( &
      hmask_dd3d, &
      scalfac_dd3d, &
      inv_dual_edge_length, &
      z_dwdz_dd, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_solve_nonhydro_stencil_17 &
         ( &
         hmask_dd3d, &
         scalfac_dd3d, &
         inv_dual_edge_length, &
...
#else
      call run_mo_solve_nonhydro_stencil_17 &
         ( &
         hmask_dd3d, &
         scalfac_dd3d, &
         inv_dual_edge_length, &
   ...
   subroutine &
      wrap_setup_mo_solve_nonhydro_stencil_17( &
      mesh, &
      k_size, &
      stream, &
      z_graddiv_vn_kmax &
      ...
      call setup_mo_solve_nonhydro_stencil_17 &
         ( &
         mesh, &
         k_size, &
         stream, &
