...
#include "mo_solve_nonhydro_stencil_18.hpp"
...
class mo_solve_nonhydro_stencil_18 {
public:
  struct GpuTriMesh {
    int NumVertices;
    int NumEdges;
...
public:
  ...
  void run(const int verticalStart, const int verticalEnd,
    ...
    if (!is_setup_) {
      printf("mo_solve_nonhydro_stencil_18 has not been set up! make sure "
    ...
    generated::mo_solve_nonhydro_stencil_18(connectivities)(
...
extern "C" {
void run_mo_solve_nonhydro_stencil_18(
    double *inv_dual_edge_length, double *z_exner_ex_pr, double *z_gradh_exner,
    const int verticalStart, const int verticalEnd, const int horizontalStart,
    const int horizontalEnd) {
  dawn_generated::cuda_ico::mo_solve_nonhydro_stencil_18 s;
  s.copy_pointers(inv_dual_edge_length, z_exner_ex_pr, z_gradh_exner);
  s.run(verticalStart, verticalEnd, horizontalStart, horizontalEnd);
  return;
}

bool verify_mo_solve_nonhydro_stencil_18(const double *z_gradh_exner_dsl,
  ...
  const auto &mesh =
      dawn_generated::cuda_ico::mo_solve_nonhydro_stencil_18::getMesh();
  cudaStream_t stream =
      dawn_generated::cuda_ico::mo_solve_nonhydro_stencil_18::getStream();
  int kSize =
      dawn_generated::cuda_ico::mo_solve_nonhydro_stencil_18::getKSize();
  high_resolution_clock::time_point t_start = high_resolution_clock::now();
  struct VerificationMetrics stencilMetrics;

  int z_gradh_exner_kSize = dawn_generated::cuda_ico::
      mo_solve_nonhydro_stencil_18::get_z_gradh_exner_KSize();
  ...
  MetricsSerialiser serialiser_z_gradh_exner(
      ...
      "mo_solve_nonhydro_stencil_18", "z_gradh_exner");
  ...
  if (!stencilMetrics.isValid) {
    ...
    serialize_dense_edges(0, (mesh.NumEdges - 1), z_gradh_exner_kSize,
                          ...
                          "mo_solve_nonhydro_stencil_18", "z_gradh_exner_dsl",
                          iteration);
...
#ifdef __SERIALIZE_ON_ERROR
  serialize_flush_iter("mo_solve_nonhydro_stencil_18", iteration);
#endif
...
void run_and_verify_mo_solve_nonhydro_stencil_18(
    double *inv_dual_edge_length, double *z_exner_ex_pr, double *z_gradh_exner,
  ...
  std::cout << "[DSL] Running stencil mo_solve_nonhydro_stencil_18 ("
            << iteration << ") ...\n"
            << std::flush;
  run_mo_solve_nonhydro_stencil_18(inv_dual_edge_length, z_exner_ex_pr,
                                   z_gradh_exner_before, verticalStart,
                                   verticalEnd, horizontalStart, horizontalEnd);

  std::cout << "[DSL] mo_solve_nonhydro_stencil_18 run time: " << time << "s\n"
            << std::flush;
  std::cout << "[DSL] Verifying stencil mo_solve_nonhydro_stencil_18...\n"
            << std::flush;
  verify_mo_solve_nonhydro_stencil_18(z_gradh_exner_before, z_gradh_exner,
...
void setup_mo_solve_nonhydro_stencil_18(dawn::GlobalGpuTriMesh *mesh,
                                        int k_size, cudaStream_t stream,
                                        const int z_gradh_exner_k_size) {
  dawn_generated::cuda_ico::mo_solve_nonhydro_stencil_18::setup(
      mesh, k_size, stream, z_gradh_exner_k_size);
}

void free_mo_solve_nonhydro_stencil_18() {
  dawn_generated::cuda_ico::mo_solve_nonhydro_stencil_18::free();
}
}
