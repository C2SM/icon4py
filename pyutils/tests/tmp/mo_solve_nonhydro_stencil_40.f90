...
module mo_solve_nonhydro_stencil_40
   use, intrinsic :: iso_c_binding
   implicit none
   interface
      subroutine &
         run_mo_solve_nonhydro_stencil_40( &
         e_bln_c_s, &
         z_w_concorr_me, &
         wgtfacq_c, &
         w_concorr_c, &
      ...
      subroutine &
         run_and_verify_mo_solve_nonhydro_stencil_40( &
         e_bln_c_s, &
         z_w_concorr_me, &
         wgtfacq_c, &
         w_concorr_c, &
      ...
      subroutine &
         setup_mo_solve_nonhydro_stencil_40( &
         mesh, &
         k_size, &
         stream, &
         w_concorr_c_kmax &
      ...
      subroutine &
         free_mo_solve_nonhydro_stencil_40() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_solve_nonhydro_stencil_40( &
      e_bln_c_s, &
      z_w_concorr_me, &
      wgtfacq_c, &
      w_concorr_c, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_solve_nonhydro_stencil_40 &
         ( &
         e_bln_c_s, &
         z_w_concorr_me, &
         wgtfacq_c, &
...
#else
      call run_mo_solve_nonhydro_stencil_40 &
         ( &
         e_bln_c_s, &
         z_w_concorr_me, &
         wgtfacq_c, &
   ...
   subroutine &
      wrap_setup_mo_solve_nonhydro_stencil_40( &
      mesh, &
      k_size, &
      stream, &
      w_concorr_c_kmax &
      ...
      call setup_mo_solve_nonhydro_stencil_40 &
         ( &
         mesh, &
         k_size, &
         stream, &
