...
module mo_solve_nonhydro_stencil_57
   use, intrinsic :: iso_c_binding
   implicit none
   interface
      subroutine &
         run_mo_solve_nonhydro_stencil_57( &
         mass_flx_ic, &
         vertical_lower, &
         vertical_upper, &
         horizontal_lower, &
      ...
      subroutine &
         run_and_verify_mo_solve_nonhydro_stencil_57( &
         mass_flx_ic, &
         mass_flx_ic_before, &
         vertical_lower, &
         vertical_upper, &
      ...
      subroutine &
         setup_mo_solve_nonhydro_stencil_57( &
         mesh, &
         k_size, &
         stream, &
         mass_flx_ic_kmax &
      ...
      subroutine &
         free_mo_solve_nonhydro_stencil_57() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_solve_nonhydro_stencil_57( &
      mass_flx_ic, &
      mass_flx_ic_before, &
      vertical_lower, &
      vertical_upper, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_solve_nonhydro_stencil_57 &
         ( &
         mass_flx_ic, &
         mass_flx_ic_before, &
         vertical_start, &
...
#else
      call run_mo_solve_nonhydro_stencil_57 &
         ( &
         mass_flx_ic, &
         vertical_start, &
         vertical_end, &
   ...
   subroutine &
      wrap_setup_mo_solve_nonhydro_stencil_57( &
      mesh, &
      k_size, &
      stream, &
      mass_flx_ic_kmax &
      ...
      call setup_mo_solve_nonhydro_stencil_57 &
         ( &
         mesh, &
         k_size, &
         stream, &
