...
module mo_solve_nonhydro_stencil_49
   ...
   interface
      ...
      subroutine &
         run_and_verify_mo_solve_nonhydro_stencil_49( &
         z_rho_expl, &
         z_exner_expl, &
         rho_nnow, &
         inv_ddqz_z_full, &
      ...
      subroutine &
         setup_mo_solve_nonhydro_stencil_49( &
         mesh, &
         k_size, &
         stream, &
         z_rho_expl_kmax, &
      ...
      subroutine &
         free_mo_solve_nonhydro_stencil_49() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_solve_nonhydro_stencil_49( &
      z_rho_expl, &
      z_exner_expl, &
      rho_nnow, &
      inv_ddqz_z_full, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_solve_nonhydro_stencil_49 &
         ( &
         z_rho_expl, &
         z_exner_expl, &
         rho_nnow, &
...
#else
      call run_mo_solve_nonhydro_stencil_49 &
         ( &
         z_rho_expl, &
         z_exner_expl, &
         rho_nnow, &
   ...
   subroutine &
      wrap_setup_mo_solve_nonhydro_stencil_49( &
      mesh, &
      k_size, &
      stream, &
      z_rho_expl_kmax, &
      ...
      call setup_mo_solve_nonhydro_stencil_49 &
         ( &
         mesh, &
         k_size, &
         stream, &
