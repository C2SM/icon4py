...
module mo_nh_diffusion_stencil_16
   use, intrinsic :: iso_c_binding
   implicit none
   interface
      subroutine &
         run_mo_nh_diffusion_stencil_16( &
         z_temp, &
         area, &
         theta_v, &
         exner, &
      ...
      subroutine &
         run_and_verify_mo_nh_diffusion_stencil_16( &
         z_temp, &
         area, &
         theta_v, &
         exner, &
      ...
      subroutine &
         setup_mo_nh_diffusion_stencil_16( &
         mesh, &
         k_size, &
         stream, &
         theta_v_kmax, &
      ...
      subroutine &
         free_mo_nh_diffusion_stencil_16() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_nh_diffusion_stencil_16( &
      z_temp, &
      area, &
      theta_v, &
      exner, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_nh_diffusion_stencil_16 &
         ( &
         z_temp, &
         area, &
         theta_v, &
...
#else
      call run_mo_nh_diffusion_stencil_16 &
         ( &
         z_temp, &
         area, &
         theta_v, &
   ...
   subroutine &
      wrap_setup_mo_nh_diffusion_stencil_16( &
      mesh, &
      k_size, &
      stream, &
      theta_v_kmax, &
      ...
      call setup_mo_nh_diffusion_stencil_16 &
         ( &
         mesh, &
         k_size, &
         stream, &
