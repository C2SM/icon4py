...
module mo_solve_nonhydro_stencil_58
   ...
   interface
      subroutine &
         ...
         real(c_double), value, target :: r_nsubsteps
      ...
      subroutine &
         run_and_verify_mo_solve_nonhydro_stencil_58( &
         z_contr_w_fl_l, &
         rho_ic, &
         vwind_impl_wgt, &
         w, &
      ...
      subroutine &
         setup_mo_solve_nonhydro_stencil_58( &
         mesh, &
         k_size, &
         stream, &
         mass_flx_ic_kmax &
      ...
      subroutine &
         free_mo_solve_nonhydro_stencil_58() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_solve_nonhydro_stencil_58( &
      z_contr_w_fl_l, &
      rho_ic, &
      vwind_impl_wgt, &
      w, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_solve_nonhydro_stencil_58 &
         ( &
         z_contr_w_fl_l, &
         rho_ic, &
         vwind_impl_wgt, &
...
#else
      call run_mo_solve_nonhydro_stencil_58 &
         ( &
         z_contr_w_fl_l, &
         rho_ic, &
         vwind_impl_wgt, &
   ...
   subroutine &
      wrap_setup_mo_solve_nonhydro_stencil_58( &
      mesh, &
      k_size, &
      stream, &
      mass_flx_ic_kmax &
      ...
      call setup_mo_solve_nonhydro_stencil_58 &
         ( &
         mesh, &
         k_size, &
         stream, &
