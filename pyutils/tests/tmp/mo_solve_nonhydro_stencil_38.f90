...
module mo_solve_nonhydro_stencil_38
   use, intrinsic :: iso_c_binding
   implicit none
   interface
      subroutine &
         run_mo_solve_nonhydro_stencil_38( &
         vn, &
         wgtfacq_e, &
         vn_ie, &
         vertical_lower, &
      ...
      subroutine &
         run_and_verify_mo_solve_nonhydro_stencil_38( &
         vn, &
         wgtfacq_e, &
         vn_ie, &
         vn_ie_before, &
      ...
      subroutine &
         setup_mo_solve_nonhydro_stencil_38( &
         mesh, &
         k_size, &
         stream, &
         vn_ie_kmax &
      ...
      subroutine &
         free_mo_solve_nonhydro_stencil_38() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_solve_nonhydro_stencil_38( &
      vn, &
      wgtfacq_e, &
      vn_ie, &
      vn_ie_before, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_solve_nonhydro_stencil_38 &
         ( &
         vn, &
         wgtfacq_e, &
         vn_ie, &
...
#else
      call run_mo_solve_nonhydro_stencil_38 &
         ( &
         vn, &
         wgtfacq_e, &
         vn_ie, &
   ...
   subroutine &
      wrap_setup_mo_solve_nonhydro_stencil_38( &
      mesh, &
      k_size, &
      stream, &
      vn_ie_kmax &
      ...
      call setup_mo_solve_nonhydro_stencil_38 &
         ( &
         mesh, &
         k_size, &
         stream, &
