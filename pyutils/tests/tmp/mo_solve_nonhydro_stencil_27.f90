...
module mo_solve_nonhydro_stencil_27
   use, intrinsic :: iso_c_binding
   implicit none
   interface
      subroutine &
         run_mo_solve_nonhydro_stencil_27( &
         scal_divdamp, &
         bdy_divdamp, &
         nudgecoeff_e, &
         z_graddiv2_vn, &
         ...
         use, intrinsic :: iso_c_binding
         use openacc
         real(c_double), dimension(*), target :: scal_divdamp
         real(c_double), dimension(*), target :: bdy_divdamp
      ...
      subroutine &
         run_and_verify_mo_solve_nonhydro_stencil_27( &
         scal_divdamp, &
         bdy_divdamp, &
         nudgecoeff_e, &
         z_graddiv2_vn, &
      ...
      subroutine &
         setup_mo_solve_nonhydro_stencil_27( &
         mesh, &
         k_size, &
         stream, &
         vn_kmax &
      ...
      subroutine &
         free_mo_solve_nonhydro_stencil_27() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_solve_nonhydro_stencil_27( &
      scal_divdamp, &
      bdy_divdamp, &
      nudgecoeff_e, &
      z_graddiv2_vn, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_solve_nonhydro_stencil_27 &
         ( &
         scal_divdamp, &
         bdy_divdamp, &
         nudgecoeff_e, &
...
#else
      call run_mo_solve_nonhydro_stencil_27 &
         ( &
         scal_divdamp, &
         bdy_divdamp, &
         nudgecoeff_e, &
   ...
   subroutine &
      wrap_setup_mo_solve_nonhydro_stencil_27( &
      mesh, &
      k_size, &
      stream, &
      vn_kmax &
      ...
      call setup_mo_solve_nonhydro_stencil_27 &
         ( &
         mesh, &
         k_size, &
         stream, &
