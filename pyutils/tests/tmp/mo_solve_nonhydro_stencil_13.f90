...
module mo_solve_nonhydro_stencil_13
   use, intrinsic :: iso_c_binding
   implicit none
   interface
      subroutine &
         run_mo_solve_nonhydro_stencil_13( &
         rho, &
         rho_ref_mc, &
         theta_v, &
         theta_ref_mc, &
      ...
      subroutine &
         run_and_verify_mo_solve_nonhydro_stencil_13( &
         rho, &
         rho_ref_mc, &
         theta_v, &
         theta_ref_mc, &
      ...
      subroutine &
         setup_mo_solve_nonhydro_stencil_13( &
         mesh, &
         k_size, &
         stream, &
         z_rth_pr_1_kmax, &
      ...
      subroutine &
         free_mo_solve_nonhydro_stencil_13() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_solve_nonhydro_stencil_13 &
         ( &
         rho, &
         rho_ref_mc, &
         theta_v, &
...
#else
      call run_mo_solve_nonhydro_stencil_13 &
         ( &
         rho, &
         rho_ref_mc, &
         theta_v, &
   ...
   subroutine &
      wrap_setup_mo_solve_nonhydro_stencil_13( &
      mesh, &
      k_size, &
      stream, &
      z_rth_pr_1_kmax, &
      ...
      call setup_mo_solve_nonhydro_stencil_13 &
         ( &
         mesh, &
         k_size, &
         stream, &
