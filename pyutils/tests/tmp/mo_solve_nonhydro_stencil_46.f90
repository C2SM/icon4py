...
module mo_solve_nonhydro_stencil_46
   use, intrinsic :: iso_c_binding
   implicit none
   interface
      subroutine &
         run_mo_solve_nonhydro_stencil_46( &
         w_nnew, &
         z_contr_w_fl_l, &
         vertical_lower, &
         vertical_upper, &
      ...
      subroutine &
         run_and_verify_mo_solve_nonhydro_stencil_46( &
         w_nnew, &
         z_contr_w_fl_l, &
         w_nnew_before, &
      ...
      subroutine &
         setup_mo_solve_nonhydro_stencil_46( &
         mesh, &
         k_size, &
         stream, &
         w_nnew_kmax, &
      ...
      subroutine &
         free_mo_solve_nonhydro_stencil_46() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_solve_nonhydro_stencil_46( &
      w_nnew, &
      z_contr_w_fl_l, &
      w_nnew_before, &
      z_contr_w_fl_l_before, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_solve_nonhydro_stencil_46 &
         ( &
         w_nnew, &
         z_contr_w_fl_l, &
         w_nnew_before, &
...
#else
      call run_mo_solve_nonhydro_stencil_46 &
         ( &
         w_nnew, &
         z_contr_w_fl_l, &
         vertical_start, &
   ...
   subroutine &
      wrap_setup_mo_solve_nonhydro_stencil_46( &
      mesh, &
      k_size, &
      stream, &
      w_nnew_kmax, &
      ...
      call setup_mo_solve_nonhydro_stencil_46 &
         ( &
         mesh, &
         k_size, &
         stream, &
