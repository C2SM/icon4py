...
module mo_solve_nonhydro_stencil_56
   use, intrinsic :: iso_c_binding
   implicit none
   interface
      subroutine &
         run_mo_solve_nonhydro_stencil_56( &
         inv_ddqz_z_full, &
         w, &
         w_concorr_c, &
         z_dwdz_dd, &
      ...
      subroutine &
         run_and_verify_mo_solve_nonhydro_stencil_56( &
         inv_ddqz_z_full, &
         w, &
         w_concorr_c, &
         z_dwdz_dd, &
      ...
      subroutine &
         setup_mo_solve_nonhydro_stencil_56( &
         mesh, &
         k_size, &
         stream, &
         z_dwdz_dd_kmax &
      ...
      subroutine &
         free_mo_solve_nonhydro_stencil_56() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_solve_nonhydro_stencil_56( &
      inv_ddqz_z_full, &
      w, &
      w_concorr_c, &
      z_dwdz_dd, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_solve_nonhydro_stencil_56 &
         ( &
         inv_ddqz_z_full, &
         w, &
         w_concorr_c, &
...
#else
      call run_mo_solve_nonhydro_stencil_56 &
         ( &
         inv_ddqz_z_full, &
         w, &
         w_concorr_c, &
   ...
   subroutine &
      wrap_setup_mo_solve_nonhydro_stencil_56( &
      mesh, &
      k_size, &
      stream, &
      z_dwdz_dd_kmax &
      ...
      call setup_mo_solve_nonhydro_stencil_56 &
         ( &
         mesh, &
         k_size, &
         stream, &
