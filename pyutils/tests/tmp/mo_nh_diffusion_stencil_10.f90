...
module mo_nh_diffusion_stencil_10
   use, intrinsic :: iso_c_binding
   implicit none
   interface
      subroutine &
         run_mo_nh_diffusion_stencil_10( &
         w, &
         diff_multfac_n2w, &
         cell_area, &
         z_nabla2_c, &
         ...
         real(c_double), dimension(*), target :: diff_multfac_n2w
         real(c_double), dimension(*), target :: cell_area
      ...
      subroutine &
         run_and_verify_mo_nh_diffusion_stencil_10( &
         w, &
         diff_multfac_n2w, &
         cell_area, &
         z_nabla2_c, &
      ...
      subroutine &
         setup_mo_nh_diffusion_stencil_10( &
         mesh, &
         k_size, &
         stream, &
         w_kmax &
      ...
      subroutine &
         free_mo_nh_diffusion_stencil_10() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_nh_diffusion_stencil_10( &
      w, &
      diff_multfac_n2w, &
      cell_area, &
      z_nabla2_c, &
      ...
      !$ACC w, &
      !$ACC diff_multfac_n2w, &
      !$ACC cell_area, &
      !$ACC z_nabla2_c, &
      !$ACC w_before &
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_nh_diffusion_stencil_10 &
         ( &
         w, &
         diff_multfac_n2w, &
         cell_area, &
...
#else
      call run_mo_nh_diffusion_stencil_10 &
         ( &
         w, &
         diff_multfac_n2w, &
         cell_area, &
   ...
   subroutine &
      wrap_setup_mo_nh_diffusion_stencil_10( &
      mesh, &
      k_size, &
      stream, &
      w_kmax &
      ...
      call setup_mo_nh_diffusion_stencil_10 &
         ( &
         mesh, &
         k_size, &
         stream, &
