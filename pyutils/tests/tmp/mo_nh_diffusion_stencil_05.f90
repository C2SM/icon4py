...
module mo_nh_diffusion_stencil_05
   use, intrinsic :: iso_c_binding
   implicit none
   interface
      subroutine &
         run_mo_nh_diffusion_stencil_05( &
         area_edge, &
         kh_smag_e, &
         z_nabla2_e, &
         z_nabla4_e2, &
         ...
         real(c_double), dimension(*), target :: diff_multfac_vn
         real(c_double), dimension(*), target :: nudgecoeff_e
         real(c_double), dimension(*), target :: vn
         real(c_double), value, target :: nudgezone_diff
      ...
      subroutine &
         run_and_verify_mo_nh_diffusion_stencil_05( &
         area_edge, &
         kh_smag_e, &
         z_nabla2_e, &
         z_nabla4_e2, &
      ...
      subroutine &
         setup_mo_nh_diffusion_stencil_05( &
         mesh, &
         k_size, &
         stream, &
         vn_kmax &
      ...
      subroutine &
         free_mo_nh_diffusion_stencil_05() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_nh_diffusion_stencil_05( &
      area_edge, &
      kh_smag_e, &
      z_nabla2_e, &
      z_nabla4_e2, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_nh_diffusion_stencil_05 &
         ( &
         area_edge, &
         kh_smag_e, &
         z_nabla2_e, &
...
#else
      call run_mo_nh_diffusion_stencil_05 &
         ( &
         area_edge, &
         kh_smag_e, &
         z_nabla2_e, &
   ...
   subroutine &
      wrap_setup_mo_nh_diffusion_stencil_05( &
      mesh, &
      k_size, &
      stream, &
      vn_kmax &
      ...
      call setup_mo_nh_diffusion_stencil_05 &
         ( &
         mesh, &
         k_size, &
         stream, &
