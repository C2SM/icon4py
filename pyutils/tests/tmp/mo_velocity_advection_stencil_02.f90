...
module mo_velocity_advection_stencil_02
   ...
   interface
      ...
      subroutine &
         run_and_verify_mo_velocity_advection_stencil_02( &
         wgtfac_e, &
         vn, &
         vt, &
         vn_ie, &
      ...
      subroutine &
         setup_mo_velocity_advection_stencil_02( &
         mesh, &
         k_size, &
         stream, &
         vn_ie_kmax, &
      ...
      subroutine &
         free_mo_velocity_advection_stencil_02() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_velocity_advection_stencil_02( &
      wgtfac_e, &
      vn, &
      vt, &
      vn_ie, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_velocity_advection_stencil_02 &
         ( &
         wgtfac_e, &
         vn, &
         vt, &
...
#else
      call run_mo_velocity_advection_stencil_02 &
         ( &
         wgtfac_e, &
         vn, &
         vt, &
   ...
   subroutine &
      wrap_setup_mo_velocity_advection_stencil_02( &
      mesh, &
      k_size, &
      stream, &
      vn_ie_kmax, &
      ...
      call setup_mo_velocity_advection_stencil_02 &
         ( &
         mesh, &
         k_size, &
         stream, &
