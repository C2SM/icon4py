...
module mo_solve_nonhydro_stencil_66
   ...
   interface
      ...
      subroutine &
         run_and_verify_mo_solve_nonhydro_stencil_66( &
         bdy_halo_c, &
         rho, &
         theta_v, &
         exner, &
      ...
      subroutine &
         setup_mo_solve_nonhydro_stencil_66( &
         mesh, &
         k_size, &
         stream, &
         theta_v_kmax, &
      ...
      subroutine &
         free_mo_solve_nonhydro_stencil_66() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_solve_nonhydro_stencil_66( &
      bdy_halo_c, &
      rho, &
      theta_v, &
      exner, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_solve_nonhydro_stencil_66 &
         ( &
         bdy_halo_c, &
         rho, &
         theta_v, &
...
#else
      call run_mo_solve_nonhydro_stencil_66 &
         ( &
         bdy_halo_c, &
         rho, &
         theta_v, &
   ...
   subroutine &
      wrap_setup_mo_solve_nonhydro_stencil_66( &
      mesh, &
      k_size, &
      stream, &
      theta_v_kmax, &
      ...
      call setup_mo_solve_nonhydro_stencil_66 &
         ( &
         mesh, &
         k_size, &
         stream, &
