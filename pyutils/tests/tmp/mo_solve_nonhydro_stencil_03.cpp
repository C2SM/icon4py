...
#include "mo_solve_nonhydro_stencil_03.hpp"
...
class mo_solve_nonhydro_stencil_03 {
public:
  struct GpuTriMesh {
    int NumVertices;
    int NumEdges;
...
public:
  ...
  static void setup(const dawn::GlobalGpuTriMesh *mesh, int kSize,
                    cudaStream_t stream, const int z_exner_ex_pr_kSize) {
  ...
  void run(const int verticalStart, const int verticalEnd,
    ...
    if (!is_setup_) {
      printf("mo_solve_nonhydro_stencil_03 has not been set up! make sure "
    ...
    generated::mo_solve_nonhydro_stencil_03(connectivities)(
        cuda_backend, z_exner_ex_pr_sid, horizontalStart, horizontalEnd,
  ...
  void copy_pointers(double *z_exner_ex_pr) { z_exner_ex_pr_ = z_exner_ex_pr; }
};
} // namespace cuda_ico
} // namespace dawn_generated
...
void run_mo_solve_nonhydro_stencil_03(double *z_exner_ex_pr,
  ...
  dawn_generated::cuda_ico::mo_solve_nonhydro_stencil_03 s;
  s.copy_pointers(z_exner_ex_pr);
...
bool verify_mo_solve_nonhydro_stencil_03(const double *z_exner_ex_pr_dsl,
  ...
  const auto &mesh =
      dawn_generated::cuda_ico::mo_solve_nonhydro_stencil_03::getMesh();
  cudaStream_t stream =
      dawn_generated::cuda_ico::mo_solve_nonhydro_stencil_03::getStream();
  int kSize =
      dawn_generated::cuda_ico::mo_solve_nonhydro_stencil_03::getKSize();
  high_resolution_clock::time_point t_start = high_resolution_clock::now();
  struct VerificationMetrics stencilMetrics;

  int z_exner_ex_pr_kSize = dawn_generated::cuda_ico::
      mo_solve_nonhydro_stencil_03::get_z_exner_ex_pr_KSize();
  ...
  MetricsSerialiser serialiser_z_exner_ex_pr(
      ...
      "mo_solve_nonhydro_stencil_03", "z_exner_ex_pr");
  ...
  if (!stencilMetrics.isValid) {
    ...
    serialize_dense_cells(0, (mesh.NumCells - 1), z_exner_ex_pr_kSize,
                          ...
                          "mo_solve_nonhydro_stencil_03", "z_exner_ex_pr_dsl",
                          iteration);
...
#ifdef __SERIALIZE_ON_ERROR
  serialize_flush_iter("mo_solve_nonhydro_stencil_03", iteration);
#endif
...
void run_and_verify_mo_solve_nonhydro_stencil_03(
  ...
  std::cout << "[DSL] Running stencil mo_solve_nonhydro_stencil_03 ("
            << iteration << ") ...\n"
            << std::flush;
  run_mo_solve_nonhydro_stencil_03(z_exner_ex_pr_before, verticalStart,
                                   verticalEnd, horizontalStart, horizontalEnd);

  std::cout << "[DSL] mo_solve_nonhydro_stencil_03 run time: " << time << "s\n"
            << std::flush;
  std::cout << "[DSL] Verifying stencil mo_solve_nonhydro_stencil_03...\n"
            << std::flush;
  verify_mo_solve_nonhydro_stencil_03(z_exner_ex_pr_before, z_exner_ex_pr,
...
void setup_mo_solve_nonhydro_stencil_03(dawn::GlobalGpuTriMesh *mesh,
  ...
  dawn_generated::cuda_ico::mo_solve_nonhydro_stencil_03::setup(
      mesh, k_size, stream, z_exner_ex_pr_k_size);
}

void free_mo_solve_nonhydro_stencil_03() {
  dawn_generated::cuda_ico::mo_solve_nonhydro_stencil_03::free();
}
}
