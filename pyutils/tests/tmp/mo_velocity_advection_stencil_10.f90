...
module mo_velocity_advection_stencil_10
   ...
   interface
      ...
      subroutine &
         run_and_verify_mo_velocity_advection_stencil_10( &
         z_w_concorr_mc, &
         wgtfac_c, &
         w_concorr_c, &
         w_concorr_c_before, &
      ...
      subroutine &
         setup_mo_velocity_advection_stencil_10( &
         mesh, &
         k_size, &
         stream, &
         w_concorr_c_kmax &
      ...
      subroutine &
         free_mo_velocity_advection_stencil_10() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_velocity_advection_stencil_10( &
      z_w_concorr_mc, &
      wgtfac_c, &
      w_concorr_c, &
      w_concorr_c_before, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_velocity_advection_stencil_10 &
         ( &
         z_w_concorr_mc, &
         wgtfac_c, &
         w_concorr_c, &
...
#else
      call run_mo_velocity_advection_stencil_10 &
         ( &
         z_w_concorr_mc, &
         wgtfac_c, &
         w_concorr_c, &
   ...
   subroutine &
      wrap_setup_mo_velocity_advection_stencil_10( &
      mesh, &
      k_size, &
      stream, &
      w_concorr_c_kmax &
      ...
      call setup_mo_velocity_advection_stencil_10 &
         ( &
         mesh, &
         k_size, &
         stream, &
