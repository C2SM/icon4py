...
module mo_solve_nonhydro_stencil_59
   use, intrinsic :: iso_c_binding
   implicit none
   interface
      subroutine &
         run_mo_solve_nonhydro_stencil_59( &
         exner, &
         exner_dyn_incr, &
         vertical_lower, &
         vertical_upper, &
      ...
      subroutine &
         run_and_verify_mo_solve_nonhydro_stencil_59( &
         exner, &
         exner_dyn_incr, &
      ...
      subroutine &
         setup_mo_solve_nonhydro_stencil_59( &
         mesh, &
         k_size, &
         stream, &
         exner_dyn_incr_kmax &
      ...
      subroutine &
         free_mo_solve_nonhydro_stencil_59() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_solve_nonhydro_stencil_59( &
      exner, &
      exner_dyn_incr, &
      exner_dyn_incr_before, &
      vertical_lower, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_solve_nonhydro_stencil_59 &
         ( &
         exner, &
         exner_dyn_incr, &
         exner_dyn_incr_before, &
...
#else
      call run_mo_solve_nonhydro_stencil_59 &
         ( &
         exner, &
         exner_dyn_incr, &
         vertical_start, &
   ...
   subroutine &
      wrap_setup_mo_solve_nonhydro_stencil_59( &
      mesh, &
      k_size, &
      stream, &
      exner_dyn_incr_kmax &
      ...
      call setup_mo_solve_nonhydro_stencil_59 &
         ( &
         mesh, &
         k_size, &
         stream, &
