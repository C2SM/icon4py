...
module mo_solve_nonhydro_stencil_42
   ...
   interface
      ...
      subroutine &
         run_and_verify_mo_solve_nonhydro_stencil_42( &
         z_w_expl, &
         w_nnow, &
         ddt_w_adv_ntl1, &
         ddt_w_adv_ntl2, &
      ...
      subroutine &
         setup_mo_solve_nonhydro_stencil_42( &
         mesh, &
         k_size, &
         stream, &
         z_w_expl_kmax, &
      ...
      subroutine &
         free_mo_solve_nonhydro_stencil_42() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_solve_nonhydro_stencil_42( &
      z_w_expl, &
      w_nnow, &
      ddt_w_adv_ntl1, &
      ddt_w_adv_ntl2, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_solve_nonhydro_stencil_42 &
         ( &
         z_w_expl, &
         w_nnow, &
         ddt_w_adv_ntl1, &
...
#else
      call run_mo_solve_nonhydro_stencil_42 &
         ( &
         z_w_expl, &
         w_nnow, &
         ddt_w_adv_ntl1, &
   ...
   subroutine &
      wrap_setup_mo_solve_nonhydro_stencil_42( &
      mesh, &
      k_size, &
      stream, &
      z_w_expl_kmax, &
      ...
      call setup_mo_solve_nonhydro_stencil_42 &
         ( &
         mesh, &
         k_size, &
         stream, &
