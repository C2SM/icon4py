...
module mo_solve_nonhydro_stencil_03
   use, intrinsic :: iso_c_binding
   implicit none
   interface
      subroutine &
         run_mo_solve_nonhydro_stencil_03( &
         z_exner_ex_pr, &
         vertical_lower, &
         vertical_upper, &
         horizontal_lower, &
      ...
      subroutine &
         run_and_verify_mo_solve_nonhydro_stencil_03( &
         z_exner_ex_pr, &
      ...
      subroutine &
         setup_mo_solve_nonhydro_stencil_03( &
         mesh, &
         k_size, &
         stream, &
         z_exner_ex_pr_kmax &
      ...
      subroutine &
         free_mo_solve_nonhydro_stencil_03() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_solve_nonhydro_stencil_03( &
      z_exner_ex_pr, &
      z_exner_ex_pr_before, &
      vertical_lower, &
      vertical_upper, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_solve_nonhydro_stencil_03 &
         ( &
         z_exner_ex_pr, &
         z_exner_ex_pr_before, &
         vertical_start, &
...
#else
      call run_mo_solve_nonhydro_stencil_03 &
         ( &
         z_exner_ex_pr, &
         vertical_start, &
         vertical_end, &
   ...
   subroutine &
      wrap_setup_mo_solve_nonhydro_stencil_03( &
      mesh, &
      k_size, &
      stream, &
      z_exner_ex_pr_kmax &
      ...
      call setup_mo_solve_nonhydro_stencil_03 &
         ( &
         mesh, &
         k_size, &
         stream, &
