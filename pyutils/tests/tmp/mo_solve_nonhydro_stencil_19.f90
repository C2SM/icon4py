...
module mo_solve_nonhydro_stencil_19
   use, intrinsic :: iso_c_binding
   implicit none
   interface
      subroutine &
         run_mo_solve_nonhydro_stencil_19( &
      ...
      subroutine &
         run_and_verify_mo_solve_nonhydro_stencil_19( &
         inv_dual_edge_length, &
         z_exner_ex_pr, &
         ddxn_z_full, &
         c_lin_e, &
      ...
      subroutine &
         setup_mo_solve_nonhydro_stencil_19( &
         mesh, &
         k_size, &
         stream, &
         z_gradh_exner_kmax &
      ...
      subroutine &
         free_mo_solve_nonhydro_stencil_19() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_solve_nonhydro_stencil_19( &
      inv_dual_edge_length, &
      z_exner_ex_pr, &
      ddxn_z_full, &
      c_lin_e, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_solve_nonhydro_stencil_19 &
         ( &
         inv_dual_edge_length, &
         z_exner_ex_pr, &
         ddxn_z_full, &
...
#else
      call run_mo_solve_nonhydro_stencil_19 &
         ( &
         inv_dual_edge_length, &
         z_exner_ex_pr, &
         ddxn_z_full, &
   ...
   subroutine &
      wrap_setup_mo_solve_nonhydro_stencil_19( &
      mesh, &
      k_size, &
      stream, &
      z_gradh_exner_kmax &
      ...
      call setup_mo_solve_nonhydro_stencil_19 &
         ( &
         mesh, &
         k_size, &
         stream, &
