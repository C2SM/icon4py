...
module mo_solve_nonhydro_stencil_61
   ...
   interface
      ...
      subroutine &
         run_and_verify_mo_solve_nonhydro_stencil_61( &
         rho_now, &
         grf_tend_rho, &
         theta_v_now, &
         grf_tend_thv, &
      ...
      subroutine &
         setup_mo_solve_nonhydro_stencil_61( &
         mesh, &
         k_size, &
         stream, &
         rho_new_kmax, &
      ...
      subroutine &
         free_mo_solve_nonhydro_stencil_61() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_solve_nonhydro_stencil_61( &
      rho_now, &
      grf_tend_rho, &
      theta_v_now, &
      grf_tend_thv, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_solve_nonhydro_stencil_61 &
         ( &
         rho_now, &
         grf_tend_rho, &
         theta_v_now, &
...
#else
      call run_mo_solve_nonhydro_stencil_61 &
         ( &
         rho_now, &
         grf_tend_rho, &
         theta_v_now, &
   ...
   subroutine &
      wrap_setup_mo_solve_nonhydro_stencil_61( &
      mesh, &
      k_size, &
      stream, &
      rho_new_kmax, &
      ...
      call setup_mo_solve_nonhydro_stencil_61 &
         ( &
         mesh, &
         k_size, &
         stream, &
