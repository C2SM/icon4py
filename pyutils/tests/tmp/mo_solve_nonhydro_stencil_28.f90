...
module mo_solve_nonhydro_stencil_28
   use, intrinsic :: iso_c_binding
   implicit none
   interface
      subroutine &
         run_mo_solve_nonhydro_stencil_28( &
         vn_incr, &
         vn, &
         iau_wgt_dyn, &
         vertical_lower, &
      ...
      subroutine &
         run_and_verify_mo_solve_nonhydro_stencil_28( &
         vn_incr, &
         vn, &
         iau_wgt_dyn, &
         vn_before, &
      ...
      subroutine &
         setup_mo_solve_nonhydro_stencil_28( &
         mesh, &
         k_size, &
         stream, &
         vn_kmax &
      ...
      subroutine &
         free_mo_solve_nonhydro_stencil_28() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_solve_nonhydro_stencil_28( &
      vn_incr, &
      vn, &
      iau_wgt_dyn, &
      vn_before, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_solve_nonhydro_stencil_28 &
         ( &
         vn_incr, &
         vn, &
         iau_wgt_dyn, &
...
#else
      call run_mo_solve_nonhydro_stencil_28 &
         ( &
         vn_incr, &
         vn, &
         iau_wgt_dyn, &
   ...
   subroutine &
      wrap_setup_mo_solve_nonhydro_stencil_28( &
      mesh, &
      k_size, &
      stream, &
      vn_kmax &
      ...
      call setup_mo_solve_nonhydro_stencil_28 &
         ( &
         mesh, &
         k_size, &
         stream, &
