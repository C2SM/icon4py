...
module mo_solve_nonhydro_stencil_26
   use, intrinsic :: iso_c_binding
   implicit none
   interface
      subroutine &
         run_mo_solve_nonhydro_stencil_26( &
         z_graddiv_vn, &
         vn, &
         scal_divdamp_o2, &
         vertical_lower, &
         ...
         real(c_double), value, target :: scal_divdamp_o2
      ...
      subroutine &
         run_and_verify_mo_solve_nonhydro_stencil_26( &
         z_graddiv_vn, &
         vn, &
         scal_divdamp_o2, &
         vn_before, &
      ...
      subroutine &
         setup_mo_solve_nonhydro_stencil_26( &
         mesh, &
         k_size, &
         stream, &
         vn_kmax &
      ...
      subroutine &
         free_mo_solve_nonhydro_stencil_26() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_solve_nonhydro_stencil_26( &
      z_graddiv_vn, &
      vn, &
      scal_divdamp_o2, &
      vn_before, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_solve_nonhydro_stencil_26 &
         ( &
         z_graddiv_vn, &
         vn, &
         scal_divdamp_o2, &
...
#else
      call run_mo_solve_nonhydro_stencil_26 &
         ( &
         z_graddiv_vn, &
         vn, &
         scal_divdamp_o2, &
   ...
   subroutine &
      wrap_setup_mo_solve_nonhydro_stencil_26( &
      mesh, &
      k_size, &
      stream, &
      vn_kmax &
      ...
      call setup_mo_solve_nonhydro_stencil_26 &
         ( &
         mesh, &
         k_size, &
         stream, &
