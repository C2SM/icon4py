...
module mo_solve_nonhydro_stencil_35
   use, intrinsic :: iso_c_binding
   implicit none
   interface
      subroutine &
         run_mo_solve_nonhydro_stencil_35( &
         vn, &
         ddxn_z_full, &
         ddxt_z_full, &
         vt, &
      ...
      subroutine &
         run_and_verify_mo_solve_nonhydro_stencil_35( &
         vn, &
         ddxn_z_full, &
         ddxt_z_full, &
         vt, &
      ...
      subroutine &
         setup_mo_solve_nonhydro_stencil_35( &
         mesh, &
         k_size, &
         stream, &
         z_w_concorr_me_kmax &
      ...
      subroutine &
         free_mo_solve_nonhydro_stencil_35() bind(c)
         use, intrinsic :: iso_c_binding
         use openacc
      end subroutine
   end interface
contains
   ...
   subroutine &
      wrap_run_mo_solve_nonhydro_stencil_35( &
      vn, &
      ddxn_z_full, &
      ddxt_z_full, &
      vt, &
      ...
      !$ACC )
#ifdef __DSL_VERIFY
      call run_and_verify_mo_solve_nonhydro_stencil_35 &
         ( &
         vn, &
         ddxn_z_full, &
         ddxt_z_full, &
...
#else
      call run_mo_solve_nonhydro_stencil_35 &
         ( &
         vn, &
         ddxn_z_full, &
         ddxt_z_full, &
   ...
   subroutine &
      wrap_setup_mo_solve_nonhydro_stencil_35( &
      mesh, &
      k_size, &
      stream, &
      z_w_concorr_me_kmax &
      ...
      call setup_mo_solve_nonhydro_stencil_35 &
         ( &
         mesh, &
         k_size, &
         stream, &
