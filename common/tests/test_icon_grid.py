...
@pytest.mark.parametrize(
    ...
    [
        ...
        (HorizontalMarkerIndex.local(CellDim) - 1, 20896),
        (HorizontalMarkerIndex.local(CellDim), 20896),
        ...
        (HorizontalMarkerIndex.lateral_boundary(CellDim) + 0, 850),
    ],
)
def test_horizontal_cell_end_indices(icon_grid, marker, index):
