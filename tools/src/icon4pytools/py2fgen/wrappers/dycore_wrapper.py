...
def solve_nh_init(
    vct_a: common.Field[[KHalfDim], gtx.float64],
    vct_b: common.Field[[KHalfDim], gtx.float64],
    cell_areas: common.Field[[CellDim], gtx.float64],
    primal_normal_cell_x: common.Field[[EdgeDim, E2CDim], gtx.float64],
    primal_normal_cell_y: common.Field[[EdgeDim, E2CDim], gtx.float64],
    dual_normal_cell_x: common.Field[[EdgeDim, E2CDim], gtx.float64],
    dual_normal_cell_y: common.Field[[EdgeDim, E2CDim], gtx.float64],
    edge_areas: common.Field[[EdgeDim], gtx.float64],
    tangent_orientation: common.Field[[EdgeDim], gtx.float64],
    inverse_primal_edge_lengths: common.Field[[EdgeDim], gtx.float64],
    inverse_dual_edge_lengths: common.Field[[EdgeDim], gtx.float64],
    inverse_vertex_vertex_lengths: common.Field[[EdgeDim], gtx.float64],
    primal_normal_vert_x: common.Field[[EdgeDim, E2C2VDim], gtx.float64],
    primal_normal_vert_y: common.Field[[EdgeDim, E2C2VDim], gtx.float64],
    dual_normal_vert_x: common.Field[[EdgeDim, E2C2VDim], gtx.float64],
    dual_normal_vert_y: common.Field[[EdgeDim, E2C2VDim], gtx.float64],
    f_e: common.Field[[EdgeDim], gtx.float64],
    c_lin_e: common.Field[[EdgeDim, E2CDim], gtx.float64],
    c_intp: common.Field[[VertexDim, V2CDim], gtx.float64],
    e_flx_avg: common.Field[[EdgeDim, E2C2EODim], gtx.float64],
    geofac_grdiv: common.Field[[EdgeDim, E2C2EODim], gtx.float64],
    geofac_rot: common.Field[[VertexDim, V2EDim], gtx.float64],
    pos_on_tplane_e_1: common.Field[[EdgeDim, E2CDim], gtx.float64],
    pos_on_tplane_e_2: common.Field[[EdgeDim, E2CDim], gtx.float64],
    rbf_vec_coeff_e: common.Field[[EdgeDim, E2C2EDim], gtx.float64],
    e_bln_c_s: common.Field[[CellDim, C2EDim], gtx.float64],
    rbf_coeff_1: common.Field[[VertexDim, V2EDim], gtx.float64],
    rbf_coeff_2: common.Field[[VertexDim, V2EDim], gtx.float64],
    geofac_div: common.Field[[CellDim, C2EDim], gtx.float64],
    geofac_n2s: common.Field[[CellDim, C2E2CODim], gtx.float64],
    geofac_grg_x: common.Field[[CellDim, C2E2CODim], gtx.float64],
    geofac_grg_y: common.Field[[CellDim, C2E2CODim], gtx.float64],
    nudgecoeff_e: common.Field[[EdgeDim], gtx.float64],
    bdy_halo_c: common.Field[[CellDim], bool],
    mask_prog_halo_c: common.Field[[CellDim], bool],
    rayleigh_w: common.Field[[KHalfDim], gtx.float64],
    exner_exfac: common.Field[[CellDim, KDim], gtx.float64],
    exner_ref_mc: common.Field[[CellDim, KDim], gtx.float64],
    wgtfac_c: common.Field[[CellDim, KHalfDim], gtx.float64],
    wgtfacq_c: common.Field[[CellDim, KDim], gtx.float64],
    inv_ddqz_z_full: common.Field[[CellDim, KDim], gtx.float64],
    rho_ref_mc: common.Field[[CellDim, KDim], gtx.float64],
    theta_ref_mc: common.Field[[CellDim, KDim], gtx.float64],
    vwind_expl_wgt: common.Field[[CellDim], gtx.float64],
    d_exner_dz_ref_ic: common.Field[[CellDim, KHalfDim], gtx.float64],
    ddqz_z_half: common.Field[[CellDim, KHalfDim], gtx.float64],
    theta_ref_ic: common.Field[[CellDim, KHalfDim], gtx.float64],
    d2dexdz2_fac1_mc: common.Field[[CellDim, KDim], gtx.float64],
    d2dexdz2_fac2_mc: common.Field[[CellDim, KDim], gtx.float64],
    rho_ref_me: common.Field[[EdgeDim, KDim], gtx.float64],
    theta_ref_me: common.Field[[EdgeDim, KDim], gtx.float64],
    ddxn_z_full: common.Field[[EdgeDim, KDim], gtx.float64],
    zdiff_gradp: common.Field[[EdgeDim, E2CDim, KDim], gtx.float64],
    vertoffset_gradp: common.Field[[EdgeDim, E2CDim, KDim], gtx.int32],
    ipeidx_dsl: common.Field[[EdgeDim, KDim], bool],
    pg_exdist: common.Field[[EdgeDim, KDim], gtx.float64],
    ddqz_z_full_e: common.Field[[EdgeDim, KDim], gtx.float64],
    ddxt_z_full: common.Field[[EdgeDim, KDim], gtx.float64],
    wgtfac_e: common.Field[[EdgeDim, KHalfDim], gtx.float64],
    wgtfacq_e: common.Field[[EdgeDim, KDim], gtx.float64],
    vwind_impl_wgt: common.Field[[CellDim], gtx.float64],
    hmask_dd3d: common.Field[[EdgeDim], gtx.float64],
    scalfac_dd3d: common.Field[[KDim], gtx.float64],
    coeff1_dwdz: common.Field[[CellDim, KDim], gtx.float64],
    coeff2_dwdz: common.Field[[CellDim, KDim], gtx.float64],
    coeff_gradekin: common.Field[[EdgeDim, E2CDim], gtx.float64],
    c_owner_mask: common.Field[[CellDim], bool],
    cell_center_lat: common.Field[[CellDim], gtx.float64],
    cell_center_lon: common.Field[[CellDim], gtx.float64],
    edge_center_lat: common.Field[[EdgeDim], gtx.float64],
    edge_center_lon: common.Field[[EdgeDim], gtx.float64],
    primal_normal_x: common.Field[[EdgeDim], gtx.float64],
    primal_normal_y: common.Field[[EdgeDim], gtx.float64],
...
def solve_nh_run(
    rho_now: common.Field[[CellDim, KDim], gtx.float64],
    rho_new: common.Field[[CellDim, KDim], gtx.float64],
    exner_now: common.Field[[CellDim, KDim], gtx.float64],
    exner_new: common.Field[[CellDim, KDim], gtx.float64],
    w_now: common.Field[[CellDim, KHalfDim], gtx.float64],
    w_new: common.Field[[CellDim, KHalfDim], gtx.float64],
    theta_v_now: common.Field[[CellDim, KDim], gtx.float64],
    theta_v_new: common.Field[[CellDim, KDim], gtx.float64],
    vn_now: common.Field[[EdgeDim, KDim], gtx.float64],
    vn_new: common.Field[[EdgeDim, KDim], gtx.float64],
    w_concorr_c: common.Field[[CellDim, KHalfDim], gtx.float64],
    ddt_vn_apc_ntl1: common.Field[[EdgeDim, KDim], gtx.float64],
    ddt_vn_apc_ntl2: common.Field[[EdgeDim, KDim], gtx.float64],
    ddt_w_adv_ntl1: common.Field[[CellDim, KHalfDim], gtx.float64],
    ddt_w_adv_ntl2: common.Field[[CellDim, KHalfDim], gtx.float64],
    theta_v_ic: common.Field[[CellDim, KHalfDim], gtx.float64],
    rho_ic: common.Field[[CellDim, KHalfDim], gtx.float64],
    exner_pr: common.Field[[CellDim, KDim], gtx.float64],
    exner_dyn_incr: common.Field[[CellDim, KDim], gtx.float64],
    ddt_exner_phy: common.Field[[CellDim, KDim], gtx.float64],
    grf_tend_rho: common.Field[[CellDim, KDim], gtx.float64],
    grf_tend_thv: common.Field[[CellDim, KDim], gtx.float64],
    grf_tend_w: common.Field[[CellDim, KHalfDim], gtx.float64],
    mass_fl_e: common.Field[[EdgeDim, KDim], gtx.float64],
    ddt_vn_phy: common.Field[[EdgeDim, KDim], gtx.float64],
    grf_tend_vn: common.Field[[EdgeDim, KDim], gtx.float64],
    vn_ie: common.Field[[EdgeDim, KHalfDim], gtx.float64],
    vt: common.Field[[EdgeDim, KDim], gtx.float64],
    mass_flx_me: common.Field[[EdgeDim, KDim], gtx.float64],
    mass_flx_ic: common.Field[[CellDim, KHalfDim], gtx.float64],
    vn_traj: common.Field[[EdgeDim, KDim], gtx.float64],
    dtime: gtx.float64,
    lprep_adv: bool,
    clean_mflx: bool,
    recompute: bool,
