...
def diffusion_init(
    ...
    num_edges: int32,
    num_vertices: int32,
    cells_start_index: Field[[Dim1], int32],
    cells_end_index: Field[[Dim1], int32],
    edge_start_index: Field[[Dim2], int32],
    edge_end_index: Field[[Dim2], int32],
    vertex_start_index: Field[[Dim3], int32],
    vertex_end_index: Field[[Dim3], int32],
