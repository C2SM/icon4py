...
def solve_nh_init_parallel(
    ...
    global icon_grid
    icon_grid = construct_icon_grid_solve_nh(
        cells_start_index,
        cells_end_index,
        vert_start_index,
        vert_end_index,
...
# todo: for now we need to granule interface as our Fortran interfaces do not yet support optional arguments.
def solve_nh_init(
    vct_a: Field[[KDim], float64],
    vct_b: Field[[KDim], float64],
    nrdmax: int32,
