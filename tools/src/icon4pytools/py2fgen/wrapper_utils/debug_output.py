...
def print_grid_decomp_info(
    ...
    log.debug(
        ...
        icon_grid.start_indices[CellDim],
    )
    log.debug(
        "icon_grid:cell_end for rank %s is.... %s",
        processor_props.rank,
        icon_grid.end_indices[CellDim],
    )
    log.debug(
        "icon_grid:vert_start for rank %s is.... %s",
        processor_props.rank,
        icon_grid.start_indices[VertexDim],
    )
    log.debug(
        "icon_grid:vert_end for rank %s is.... %s",
        processor_props.rank,
        icon_grid.end_indices[VertexDim],
    )
    log.debug(
        "icon_grid:edge_start for rank %s is.... %s",
        processor_props.rank,
        icon_grid.start_indices[EdgeDim],
    )
    log.debug(
        "icon_grid:edge_end for rank %s is.... %s",
        processor_props.rank,
        icon_grid.end_indices[EdgeDim],
    )
    log.debug(
