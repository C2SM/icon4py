...
from model_eval_cscs_exclaim.cli import calc_dwt_dist
...
# Page title
st.title("Upload a File and Choose a compressor")
...
# Dropdown options
options = ["t", "q"]
selected_option_field = st.selectbox("Choose field to compress", options)
...
if st.button("Submit"):
    if uploaded_file is not None:
        ...
        field_to_compress = selected_option_field
