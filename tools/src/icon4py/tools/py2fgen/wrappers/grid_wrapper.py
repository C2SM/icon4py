...
def grid_init(
    ...
    cell_center_lat: gtx.Field[gtx.Dims[dims.CellDim], wpfloat],
    cell_center_lon: gtx.Field[gtx.Dims[dims.CellDim], wpfloat],
    cell_areas: gtx.Field[gtx.Dims[dims.CellDim], wpfloat],
    ...
    vct_a: gtx.Field[gtx.Dims[dims.KDim], wpfloat],
    vct_b: gtx.Field[gtx.Dims[dims.KDim], wpfloat],
    lowest_layer_thickness: wpfloat,
    model_top_height: wpfloat,
    stretch_factor: wpfloat,
    flat_height: wpfloat,
    rayleigh_damping_height: wpfloat,
