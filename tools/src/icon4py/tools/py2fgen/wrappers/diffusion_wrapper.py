...
def diffusion_init(
    ...
    zd_intcoef: gtx.Field[gtx.Dims[dims.CellDim, dims.C2E2CDim, dims.KDim], wpfloat] | None,
    ...
    smagorinski_scaling_factor: wpfloat,
    hdiff_temp: bool,
    thslp_zdiffu: wpfloat,
    thhgtd_zdiffu: wpfloat,
    denom_diffu_v: wpfloat,
...
@icon4py_export.export
def diffusion_run(
    w: gtx.Field[gtx.Dims[dims.CellDim, dims.KDim], wpfloat],
    vn: fa.EdgeKField[wpfloat],
    exner: fa.CellKField[wpfloat],
    theta_v: fa.CellKField[wpfloat],
    rho: fa.CellKField[wpfloat],
    hdef_ic: gtx.Field[gtx.Dims[dims.CellDim, dims.KDim], wpfloat] | None,
    div_ic: gtx.Field[gtx.Dims[dims.CellDim, dims.KDim], wpfloat] | None,
    dwdx: gtx.Field[gtx.Dims[dims.CellDim, dims.KDim], wpfloat] | None,
    dwdy: gtx.Field[gtx.Dims[dims.CellDim, dims.KDim], wpfloat] | None,
    dtime: wpfloat,
    linit: bool,
):
    dtime = wpfloat(dtime)
