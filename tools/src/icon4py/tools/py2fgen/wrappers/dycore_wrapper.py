...
def solve_nh_init(
    vct_a: gtx.Field[[dims.KHalfDim], gtx.float64],
    vct_b: gtx.Field[[dims.KHalfDim], gtx.float64],
    cell_areas: gtx.Field[[dims.CellDim], gtx.float64],
    primal_normal_cell_x: gtx.Field[[dims.EdgeDim, dims.E2CDim], gtx.float64],
    primal_normal_cell_y: gtx.Field[[dims.EdgeDim, dims.E2CDim], gtx.float64],
    dual_normal_cell_x: gtx.Field[[dims.EdgeDim, dims.E2CDim], gtx.float64],
    dual_normal_cell_y: gtx.Field[[dims.EdgeDim, dims.E2CDim], gtx.float64],
    edge_areas: gtx.Field[[dims.EdgeDim], gtx.float64],
    tangent_orientation: gtx.Field[[dims.EdgeDim], gtx.float64],
    inverse_primal_edge_lengths: gtx.Field[[dims.EdgeDim], gtx.float64],
    inverse_dual_edge_lengths: gtx.Field[[dims.EdgeDim], gtx.float64],
    inverse_vertex_vertex_lengths: gtx.Field[[dims.EdgeDim], gtx.float64],
    primal_normal_vert_x: gtx.Field[[dims.EdgeDim, dims.E2C2VDim], gtx.float64],
    primal_normal_vert_y: gtx.Field[[dims.EdgeDim, dims.E2C2VDim], gtx.float64],
    dual_normal_vert_x: gtx.Field[[dims.EdgeDim, dims.E2C2VDim], gtx.float64],
    dual_normal_vert_y: gtx.Field[[dims.EdgeDim, dims.E2C2VDim], gtx.float64],
    f_e: gtx.Field[[dims.EdgeDim], gtx.float64],
    c_lin_e: gtx.Field[[dims.EdgeDim, dims.E2CDim], gtx.float64],
    c_intp: gtx.Field[[dims.VertexDim, dims.V2CDim], gtx.float64],
    e_flx_avg: gtx.Field[[dims.EdgeDim, dims.E2C2EODim], gtx.float64],
    geofac_grdiv: gtx.Field[[dims.EdgeDim, dims.E2C2EODim], gtx.float64],
    geofac_rot: gtx.Field[[dims.VertexDim, dims.V2EDim], gtx.float64],
    pos_on_tplane_e_1: gtx.Field[[dims.EdgeDim, dims.E2CDim], gtx.float64],
    pos_on_tplane_e_2: gtx.Field[[dims.EdgeDim, dims.E2CDim], gtx.float64],
    rbf_vec_coeff_e: gtx.Field[[dims.EdgeDim, dims.E2C2EDim], gtx.float64],
    e_bln_c_s: gtx.Field[[dims.CellDim, dims.C2EDim], gtx.float64],
    rbf_coeff_1: gtx.Field[[dims.VertexDim, dims.V2EDim], gtx.float64],
    rbf_coeff_2: gtx.Field[[dims.VertexDim, dims.V2EDim], gtx.float64],
    geofac_div: gtx.Field[[dims.CellDim, dims.C2EDim], gtx.float64],
    geofac_n2s: gtx.Field[[dims.CellDim, dims.C2E2CODim], gtx.float64],
    geofac_grg_x: gtx.Field[[dims.CellDim, dims.C2E2CODim], gtx.float64],
    geofac_grg_y: gtx.Field[[dims.CellDim, dims.C2E2CODim], gtx.float64],
    nudgecoeff_e: gtx.Field[[dims.EdgeDim], gtx.float64],
    bdy_halo_c: gtx.Field[[dims.CellDim], bool],
    mask_prog_halo_c: gtx.Field[[dims.CellDim], bool],
    rayleigh_w: gtx.Field[[dims.KHalfDim], gtx.float64],
    exner_exfac: gtx.Field[[dims.CellDim, dims.KDim], gtx.float64],
    exner_ref_mc: gtx.Field[[dims.CellDim, dims.KDim], gtx.float64],
    wgtfac_c: gtx.Field[[dims.CellDim, dims.KHalfDim], gtx.float64],
    wgtfacq_c: gtx.Field[[dims.CellDim, dims.KDim], gtx.float64],
    inv_ddqz_z_full: gtx.Field[[dims.CellDim, dims.KDim], gtx.float64],
    rho_ref_mc: gtx.Field[[dims.CellDim, dims.KDim], gtx.float64],
    theta_ref_mc: gtx.Field[[dims.CellDim, dims.KDim], gtx.float64],
    vwind_expl_wgt: gtx.Field[[dims.CellDim], gtx.float64],
    d_exner_dz_ref_ic: gtx.Field[[dims.CellDim, dims.KHalfDim], gtx.float64],
    ddqz_z_half: gtx.Field[[dims.CellDim, dims.KHalfDim], gtx.float64],
    theta_ref_ic: gtx.Field[[dims.CellDim, dims.KHalfDim], gtx.float64],
    d2dexdz2_fac1_mc: gtx.Field[[dims.CellDim, dims.KDim], gtx.float64],
    d2dexdz2_fac2_mc: gtx.Field[[dims.CellDim, dims.KDim], gtx.float64],
    rho_ref_me: gtx.Field[[dims.EdgeDim, dims.KDim], gtx.float64],
    theta_ref_me: gtx.Field[[dims.EdgeDim, dims.KDim], gtx.float64],
    ddxn_z_full: gtx.Field[[dims.EdgeDim, dims.KDim], gtx.float64],
    zdiff_gradp: gtx.Field[[dims.EdgeDim, dims.E2CDim, dims.KDim], gtx.float64],
    vertoffset_gradp: gtx.Field[[dims.EdgeDim, dims.E2CDim, dims.KDim], gtx.int32],
    pg_edgeidx_dsl: gtx.Field[[dims.EdgeDim, dims.KDim], bool],
    pg_exdist: gtx.Field[[dims.EdgeDim, dims.KDim], gtx.float64],
    ddqz_z_full_e: gtx.Field[[dims.EdgeDim, dims.KDim], gtx.float64],
    ddxt_z_full: gtx.Field[[dims.EdgeDim, dims.KDim], gtx.float64],
    wgtfac_e: gtx.Field[[dims.EdgeDim, dims.KHalfDim], gtx.float64],
    wgtfacq_e: gtx.Field[[dims.EdgeDim, dims.KDim], gtx.float64],
    vwind_impl_wgt: gtx.Field[[dims.CellDim], gtx.float64],
    hmask_dd3d: gtx.Field[[dims.EdgeDim], gtx.float64],
    scalfac_dd3d: gtx.Field[[dims.KDim], gtx.float64],
    coeff1_dwdz: gtx.Field[[dims.CellDim, dims.KDim], gtx.float64],
    coeff2_dwdz: gtx.Field[[dims.CellDim, dims.KDim], gtx.float64],
    coeff_gradekin: gtx.Field[[dims.EdgeDim, dims.E2CDim], gtx.float64],
    c_owner_mask: gtx.Field[[dims.CellDim], bool],
    cell_center_lat: gtx.Field[[dims.CellDim], gtx.float64],
    cell_center_lon: gtx.Field[[dims.CellDim], gtx.float64],
    edge_center_lat: gtx.Field[[dims.EdgeDim], gtx.float64],
    edge_center_lon: gtx.Field[[dims.EdgeDim], gtx.float64],
    primal_normal_x: gtx.Field[[dims.EdgeDim], gtx.float64],
    primal_normal_y: gtx.Field[[dims.EdgeDim], gtx.float64],
