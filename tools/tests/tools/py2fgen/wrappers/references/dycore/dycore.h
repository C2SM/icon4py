...
extern int solve_nh_init_wrapper(
    ...
    int nudgecoeff_e_size_0, int *mask_prog_halo_c, int mask_prog_halo_c_size_0,
    ...
    int zdiff_gradp_size_2, int *vertoffset_gradp, int vertoffset_gradp_size_0,
    int vertoffset_gradp_size_1, int vertoffset_gradp_size_2, int *ipeidx_dsl,
    int ipeidx_dsl_size_0, int ipeidx_dsl_size_1, double *pg_exdist,
    int pg_exdist_size_0, int pg_exdist_size_1, double *ddqz_z_full_e,
    ...
    int coeff_gradekin_size_0, int coeff_gradekin_size_1, int *c_owner_mask,
    ...
    double divdamp_z, double divdamp_z2, double divdamp_z3,
    double divdamp_z4, int nflat_gradp, int backend, int on_gpu);
