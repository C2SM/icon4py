...
extern int diffusion_init_wrapper(
    ...
    int rbf_coeff_2_size_0, int rbf_coeff_2_size_1, int *zd_cellidx,
    int zd_cellidx_size_0, int *zd_vertidx, int zd_vertidx_size_0,
    int zd_vertidx_size_1, int zd_vertidx_size_2, int zd_vertidx_size_3,
    double *zd_intcoef, int zd_intcoef_size_0, int zd_intcoef_size_1,
    int zd_intcoef_size_2, double *zd_diffcoef, int zd_diffcoef_size_0,
