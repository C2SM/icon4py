#! /bin/bash
#SBATCH --job-name=icon4py_driver_r2b6_2nodes
#SBATCH --output=/capstor/scratch/cscs/cong/run/r2b6_2nodes/output_%j/log_stdout.txt
#SBATCH --error=/capstor/scratch/cscs/cong/run/r2b6_2nodes/output_%j/log
