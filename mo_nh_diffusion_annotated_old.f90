...
!$DSL       diff_multfac_vn=diff_multfac_vn(:); nudgecoeff_e=p_int%nudgecoeff_e(:,1); vn=p_nh_prog%vn(:,:,1); &
...
!$DSL START(name=mo_nh_diffusion_stencil_11; thresh_tdiff=thresh_tdiff; theta_v=p_nh_prog%theta_v(:,:,1); &
!$DSL       theta_ref_mc=p_nh_metrics%theta_ref_mc(:,:,1); enh_diffu_3d=enh_diffu_3d(:,:,1); &
!$DSL       vertical_lower=nlev-1; vertical_upper=nlev; horizontal_lower=i_startidx; horizontal_upper=i_endidx)
...
!$DSL START(name=mo_nh_diffusion_stencil_12; kh_smag_e=kh_smag_e(:,:,1); enh_diffu_3d=enh_diffu_3d(:,:,1); &
!$DSL       vertical_lower=nlev-1; vertical_upper=nlev; horizontal_lower=i_startidx; horizontal_upper=i_endidx)
...
!$ACC END PARALLEL LOOP
     ...
     DO jb = i_startblk,i_endblk
       ...
       !$DSL END(name=mo_nh_diffusion_stencil_12)
...
!$DSL START(name=mo_nh_diffusion_stencil_13; kh_smag_e=kh_smag_e(:,:,1); &
!$DSL            inv_dual_edge_length=p_patch%edges%inv_dual_edge_length(:,1); theta_v=p_nh_prog%theta_v(:,:,1); &
!$DSL            z_nabla2_e=z_nabla2_e(:,:,1); vertical_lower=1; vertical_upper=nlev; horizontal_lower=i_startidx; &
!$DSL            horizontal_upper=i_endidx)
...
!$DSL START(name=mo_nh_diffusion_stencil_14; z_nabla2_e=z_nabla2_e(:,:,1); z_temp=z_temp(:,:,1); &
!$DSL       geofac_div=p_int%geofac_div(:,:,1); vertical_lower=1; vertical_upper=nlev; horizontal_lower=i_startidx; &
!$DSL       horizontal_upper=i_endidx)
