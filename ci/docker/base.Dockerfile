...
RUN wget -P /tmp https://github.com/CodSpeedHQ/valgrind-codspeed/releases/download/3.24.0-0codspeed1/valgrind_3.24.0-0codspeed1_ubuntu-22.04_arm64.deb && apt install -y /tmp/valgrind_3.24.0-0codspeed1_ubuntu-22.04_arm64.deb && rm /tmp/valgrind_3.24.0-0codspeed1_ubuntu-22.04_arm64.deb
