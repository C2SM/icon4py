...
from icon4py.model.atm_dyn_iconam.mo_solve_nonhydro_stencil_64 import (
...
def test_mo_solve_nonhydro_stencil_64():
    mesh = SimpleMesh()

    mass_flx_ic = zero_field(mesh, CellDim, KDim)

    ref = mo_solve_nonhydro_stencil_64_numpy(np.asarray(mass_flx_ic))
