...
def mo_icon_interpolation_scalar_cells2verts_scalar_ri_dsl_numpy(mesh, p_cell_in: np.array, c_intp: np.array) -> np.array:
...
class TestMoIconInterpolationScalarCells2vertsScalarRiDsl(StencilTest):
    ...
    def reference(mesh, p_cell_in: np.array, c_intp: np.array, **kwargs) -> dict:
        p_vert_out = mo_icon_interpolation_scalar_cells2verts_scalar_ri_dsl_numpy(mesh, p_cell_in, c_intp)
