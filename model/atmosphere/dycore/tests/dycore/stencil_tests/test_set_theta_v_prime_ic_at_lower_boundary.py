...
def set_theta_v_prime_ic_at_lower_boundary_numpy(
    ...
    perturbed_theta_v_at_cells_on_half_levels = interpolate_to_surface_numpy(
        wgtfacq_c=wgtfacq_c,
...
class TestInitThetaVPrimeIcAtLowerBoundary(StencilTest):
    ...
    OUTPUTS = ("perturbed_theta_v_at_cells_on_half_levels", "theta_v_at_cells_on_half_levels")
