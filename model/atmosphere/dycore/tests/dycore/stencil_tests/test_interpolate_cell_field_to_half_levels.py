...
class TestInterpolateToHalfLevelsVp(StencilTest):
    ...
    def input_data(self, grid: base.Grid) -> dict[str, Any]:
        ...
        out = zero_field(grid, dims.CellDim, dims.KHalfDim, dtype=ta.vpfloat)
...
class TestInterpolateToHalfLevelsWp(StencilTest):
    ...
    def input_data(self, grid: base.Grid) -> dict[str, Any]:
        ...
        wgtfac_c = random_field(grid, dims.CellDim, dims.KHalfDim, dtype=ta.wpfloat)
        out = zero_field(grid, dims.CellDim, dims.KHalfDim, dtype=ta.wpfloat)
