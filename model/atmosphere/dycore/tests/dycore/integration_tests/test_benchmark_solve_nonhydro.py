...
def solve_nonhydro(
    ...
    cell_geometry = grid_states.CellParams(
        ...
        mean_cell_area=geometry_field_source.export_field(geometry_meta.MEAN_CELL_AREA),  # type: ignore[arg-type]
    )
    ...
    interpolation_state = dycore_states.InterpolationState(
        ...
        rbf_vec_coeff_e=interpolation_field_source.export_field(interpolation_attributes.RBF_VEC_COEFF_E),
    ...
    metric_state_nonhydro = dycore_states.MetricStateNonHydro(
        ...
        d2dexdz2_fac2_mc=metrics_field_source.export_field(metrics_attributes.D2DEXDZ2_FAC1_MC),
