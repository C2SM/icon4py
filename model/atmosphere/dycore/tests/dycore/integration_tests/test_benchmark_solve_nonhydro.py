...
# TODO make it backend-like aware
...
def solve_nonhydro(
    ...
    vct_a, vct_b = v_grid.get_vct_a_and_vct_b(vertical_config, allocator=backend)
...
def test_benchmark_solve_nonhydro(
    ...
    diagnostic_state_nh = dycore_states.DiagnosticStateNonHydro(
        ...
        vn_on_half_levels=data_alloc.zero_field(
            mesh, dims.EdgeDim, dims.KDim, extend={dims.KDim: 1}, allocator=backend
        ),
