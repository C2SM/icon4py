...
def interpolate_contravariant_vertical_verlocity_to_full_levels_numpy(grid, z_w_con_c: np.array):
...
class TestInterpolateContravariantVerticalVerlocityToFullLevels(StencilTest):
    PROGRAM = interpolate_contravariant_vertical_verlocity_to_full_levels
