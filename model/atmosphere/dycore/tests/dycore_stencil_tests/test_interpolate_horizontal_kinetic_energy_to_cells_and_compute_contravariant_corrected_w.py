...
class TestInterpolateHorizontalKineticEnergyToCellsAndComputeContravariantCorrectedW(StencilTest):
    PROGRAM = interpolate_horizontal_kinetic_energy_to_cells_and_compute_contravariant_corrected_w
    OUTPUTS = (
