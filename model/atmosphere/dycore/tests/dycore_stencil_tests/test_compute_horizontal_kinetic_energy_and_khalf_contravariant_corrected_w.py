...
from icon4py.model.atmosphere.dycore.compute_cell_diagnostics_for_velocity_advection import (
    compute_horizontal_kinetic_energy_and_khalf_contravariant_corrected_w,
)
...
class TestComputeHorizontalKineticEnergyAndKhalfContravariantCorrectedW(StencilTest):
    PROGRAM = compute_horizontal_kinetic_energy_and_khalf_contravariant_corrected_w
    OUTPUTS = (
