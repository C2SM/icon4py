...
class TestFusedVelocityAdvectionStencil8To13_predictor(StencilTest):
    PROGRAM = fused_velocity_advection_stencil_8_to_13_predictor
    OUTPUTS = (
        "z_ekinh",
        "w_concorr_c",
        "z_w_con_c",
    ...
    def input_data(self, grid):
        ...
        end_halo = grid.end_index(cell_domain(h_grid.Zone.HALO))
        horizontal_start = 0
...
class TestFusedVelocityAdvectionStencil8To13_corrector(StencilTest):
    ...
    def input_data(self, grid):
        ...
        return dict(
            ...
            nlev=nlev,
            nflatlev=nflatlev,
            lateral_boundary=lateral_boundary_3,
            end_halo=end_halo,
            horizontal_start=horizontal_start,
            horizontal_end=horizontal_end,
            vertical_start=vertical_start,
