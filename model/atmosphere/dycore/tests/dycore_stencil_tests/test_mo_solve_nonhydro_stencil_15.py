...
from icon4py.model.atmosphere.dycore.mo_solve_nonhydro_stencil_15 import (
...
class TestMoSolveNonhydroStencil15(StencilTest):
    PROGRAM = mo_solve_nonhydro_stencil_15
