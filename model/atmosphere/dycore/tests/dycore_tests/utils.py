...
def construct_metric_state(
    ...
    return dycore_states.MetricStateNonHydro(
        ...
        z_diag_c=savepoint.z_diag_c(),
        z_nx1_c=savepoint.z_nx1_c(),
        z_nx2_c=savepoint.z_nx2_c(),
        z_rbfmat_c=savepoint.z_rbfmat_c(),
        z_rbfval_c=savepoint.z_rbfval_c(),
        z_rhs1_c=savepoint.z_rhs1_c(),
        z_rhs2_c=savepoint.z_rhs2_c(),
        i_startidx_c=savepoint.i_startidx_c(),
        i_endidx_c=savepoint.i_endidx_c(),
        cartesian_center_c_c_x=savepoint.cartesian_center_c_c_x(),
        cartesian_center_c_c_y=savepoint.cartesian_center_c_c_y(),
        cartesian_center_c_c_z=savepoint.cartesian_center_c_c_z(),
        cartesian_center_e_c_x=savepoint.cartesian_center_e_c_x(),
        cartesian_center_e_c_y=savepoint.cartesian_center_e_c_y(),
        cartesian_center_e_c_z=savepoint.cartesian_center_e_c_z(),
        lat_c=savepoint.lat_c(),
        lon_c=savepoint.lon_c(),
        primal_cart_normal_c_x=savepoint.primal_cart_normal_c_x(),
        primal_cart_normal_c_y=savepoint.primal_cart_normal_c_y(),
        primal_cart_normal_c_z=savepoint.primal_cart_normal_c_z(),
        rbf_vec_idx_c_c=savepoint.rbf_vec_idx_c_c(),
        z_dist_c=savepoint.z_dist_c(),
