...
import icon4py.model.common.test_utils.dycore_utils
...
def test_run_solve_nonhydro_single_step(
    ...
    config = icon4py.model.common.test_utils.dycore_utils.construct_config(
    ...
    interpolation_state = (
        icon4py.model.common.test_utils.dycore_utils.construct_interpolation_state_for_nonhydro(
            interpolation_savepoint
        )
    )
    metric_state_nonhydro = icon4py.model.common.test_utils.dycore_utils.construct_nh_metric_state(
    ...
    prognostic_state_ls = icon4py.model.common.test_utils.dycore_utils.create_prognostic_states(sp)
