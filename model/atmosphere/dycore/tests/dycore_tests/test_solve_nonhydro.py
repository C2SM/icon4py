...
def test_run_solve_nonhydro_41_to_60_corrector(
    ...
    print("compiling")
    compiled_p1 = fused_solve_nonhydro_stencil_41_to_60.fused_solve_nonhydro_stencil_41_to_60_corrector_p1.with_backend(
        backend
    ).compile(
    ...
    w_1 = w[dims.KDim(0)]
    print("compiling")
    compiled_p2 = fused_solve_nonhydro_stencil_41_to_60.fused_solve_nonhydro_stencil_41_to_60_corrector_p2.with_backend(
        backend
    ).compile(
