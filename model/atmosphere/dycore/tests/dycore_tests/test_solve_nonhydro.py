...
def test_vertically_implicit_solver_at_predictor_step(
    ...
    vertically_implicit_dycore_solver.vertically_implicit_solver_at_predictor_step.with_backend(
        ...
        start_cell_index_lateral_lvl_3_for_contravariant_correction=start_cell_lateral_boundary_level_3,
        end_cell_index_halo_lvl1_for_contravariant_correction=end_cell_halo,
