...
class TestMoVelocityAdvectionStencil03(StencilTest):
    ...
    def reference(mesh, wgtfac_e: np.array, vt: np.array, **kwargs) -> np.array:
        ...
        z_vt_ie[:, 0] = 0
        return dict(z_vt_ie=z_vt_ie[int32(1) : int32(mesh.num_cells), int32(1) : int32(mesh.num_levels)])
    ...
    def input_data(self, mesh):
        ...
        return dict(
            wgtfac_e=wgtfac_e,
            vt=vt,
            z_vt_ie=z_vt_ie[int32(1) : int32(mesh.num_cells), int32(1) : int32(mesh.num_levels)],
