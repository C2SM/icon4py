...
from stencil_tests.test_mo_solve_nonhydro_stencil_01 import mo_solve_nonhydro_stencil_01_numpy
from stencil_tests.test_mo_solve_nonhydro_stencil_02 import mo_solve_nonhydro_stencil_02_numpy
from stencil_tests.test_mo_solve_nonhydro_stencil_04 import mo_solve_nonhydro_stencil_04_numpy
from stencil_tests.test_mo_solve_nonhydro_stencil_05 import mo_solve_nonhydro_stencil_05_numpy
from stencil_tests.test_mo_solve_nonhydro_stencil_06 import mo_solve_nonhydro_stencil_06_numpy
from stencil_tests.test_mo_solve_nonhydro_stencil_07 import mo_solve_nonhydro_stencil_07_numpy
from stencil_tests.test_mo_solve_nonhydro_stencil_08 import mo_solve_nonhydro_stencil_08_numpy
from stencil_tests.test_mo_solve_nonhydro_stencil_09 import mo_solve_nonhydro_stencil_09_numpy
from stencil_tests.test_mo_solve_nonhydro_stencil_10 import mo_solve_nonhydro_stencil_10_numpy
from stencil_tests.test_mo_solve_nonhydro_stencil_11_lower import (
    mo_solve_nonhydro_stencil_11_lower_numpy,
)
from stencil_tests.test_mo_solve_nonhydro_stencil_11_upper import (
    mo_solve_nonhydro_stencil_11_upper_numpy,
)
from stencil_tests.test_mo_solve_nonhydro_stencil_12 import mo_solve_nonhydro_stencil_12_numpy
from stencil_tests.test_mo_solve_nonhydro_stencil_13 import mo_solve_nonhydro_stencil_13_numpy
...
class TestFusedMoSolveNonHydroStencil1To13(StencilTest):
        ...
        if istep == 1:
            if limited_area:
                (z_rth_pr_1, z_rth_pr_2) = np.where(
                    (horizontal_lower_01 <= horz_idx) & (horz_idx < horizontal_upper_01),
                    mo_solve_nonhydro_stencil_01_numpy(
                        mesh=mesh,
            ...
            if igradp_method == 3:
                ...
                z_exner_ic[:, :n_lev] = np.where(
                    ...
                    mo_solve_nonhydro_stencil_05_numpy(
                        mesh=mesh, wgtfac_c=wgtfac_c, z_exner_ex_pr=z_exner_ex_pr
                    ),
                    z_exner_ic[:, :n_lev],
                )
                ...
                z_dexner_dz_c_1 = np.where(
                    ...
                    mo_solve_nonhydro_stencil_06_numpy(
                        mesh=mesh, z_exner_ic=z_exner_ic, inv_ddqz_z_full=inv_ddqz_z_full
                    ),
                    z_dexner_dz_c_1,
                )
    ...
    def input_data(self, mesh):
        ...
        rho_nvar = random_field(mesh, CellDim, KDim)
        theta_v_nnow = random_field(mesh, CellDim, KDim)
        theta_v_nvar = random_field(mesh, CellDim, KDim)
