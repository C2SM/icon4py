...
@field_operator
def _return_two_cell_kdim_fields_to_zero_vp() -> (
    tuple[Field[[CellDim, KDim], vpfloat], Field[[CellDim, KDim], vpfloat]]
):
    """Formerly known as _mo_solve_nonhydro_stencil_01."""
    return _return_cell_kdim_field_to_zero_vp(), _return_cell_kdim_field_to_zero_vp()


@program(grid_type=GridType.UNSTRUCTURED)
def return_two_cell_kdim_fields_to_zero_vp(
    ...
    _return_two_cell_kdim_fields_to_zero_vp(
