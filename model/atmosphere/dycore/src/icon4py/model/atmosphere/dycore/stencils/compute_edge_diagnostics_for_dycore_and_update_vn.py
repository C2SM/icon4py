...
dycore_consts: eve_utils.FrozenNamespace[wpfloat] = constants.PhysicsConstants()
...
def apply_on_vertical_level(
    ...
    on_flatlevels: fa.EdgeKField[wpfloat],
    between_flat_and_flatgradp: fa.EdgeKField[wpfloat],
    below_flatgradp: fa.EdgeKField[wpfloat],
...
def apply_hydrostatic_correction_to_horizontal_gradient_of_exner_pressure(
    ...
    z_hydro_corr: fa.EdgeField[wpfloat],
...
def _compute_horizontal_pressure_gradient(
    ...
    hydrostatic_correction_on_lowest_level: fa.EdgeField[wpfloat],
    ...
    zdiff_gradp: gtx.Field[[dims.EdgeDim, dims.E2CDim, dims.KDim], vpfloat],
    pg_exdist: fa.EdgeKField[vpfloat],
...
def _compute_rho_theta_pgrad_and_update_vn(
    ...
    pos_on_tplane_e_x: gtx.Field[[dims.EdgeDim, dims.E2CDim], wpfloat],
    pos_on_tplane_e_y: gtx.Field[[dims.EdgeDim, dims.E2CDim], wpfloat],
    primal_normal_cell_x: gtx.Field[[dims.EdgeDim, dims.E2CDim], wpfloat],
    dual_normal_cell_x: gtx.Field[[dims.EdgeDim, dims.E2CDim], wpfloat],
    primal_normal_cell_y: gtx.Field[[dims.EdgeDim, dims.E2CDim], wpfloat],
    dual_normal_cell_y: gtx.Field[[dims.EdgeDim, dims.E2CDim], wpfloat],
    ddxn_z_full: fa.EdgeKField[vpfloat],
    c_lin_e: gtx.Field[[dims.EdgeDim, dims.E2CDim], wpfloat],
    ikoffset: gtx.Field[[dims.EdgeDim, dims.E2CDim, dims.KDim], gtx.int32],
    zdiff_gradp: gtx.Field[[dims.EdgeDim, dims.E2CDim, dims.KDim], vpfloat],
