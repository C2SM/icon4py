...
def interpolate_2nd_order_divergence_of_flux_of_normal_wind_to_cell(
    z_flxdiv2order_vn_vertex: Field[[VertexDim, KDim], vpfloat],
    ...
    _interpolate_2nd_order_divergence_of_flux_of_normal_wind_to_cell(
        z_flxdiv2order_vn_vertex,
        out=z_flxdiv_vn,
        domain={
