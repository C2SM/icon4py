...
from icon4py.model.atmosphere.dycore.stencils.solve_tridiagonal_matrix_for_w_forward_sweep import (
    _solve_tridiagonal_matrix_for_w_forward_sweep, _w,
)
...
def _fused_solve_nonhydro_stencil_41_to_60_predictor_p1(
    ...
    return z_flxdiv_mass, z_flxdiv_theta, z_w_expl, z_contr_w_fl_l, z_beta, z_alpha, z_q, w, z_rho_expl, z_exner_expl, w_prev, z_q_prev, z_a, z_b, z_c, w_prep


@field_operator
def _fused_solve_nonhydro_stencil_41_to_60_predictor_p3(
    geofac_div: Field[[CEDim], wpfloat],
    mass_fl_e: fa.EdgeKField[wpfloat],
    z_theta_v_fl_e: fa.EdgeKField[wpfloat],
    z_flxdiv_mass: fa.CellKField[vpfloat],
...
def fused_solve_nonhydro_stencil_41_to_60_predictor(
    ...
    vol_flx_ic: fa.CellKField[wpfloat],
    # new fields
    buffer: fa.CellKField[bool],
    w_prev: fa.CellKField[wpfloat],
    z_q_prev: fa.CellKField[wpfloat],
    z_a: fa.CellKField[wpfloat],
    z_b: fa.CellKField[wpfloat],
    z_c: fa.CellKField[wpfloat],
    ...
    _fused_solve_nonhydro_stencil_41_to_60_predictor_p1(
        ...
        kstart_dd3d=kstart_dd3d,
        kstart_moist=kstart_moist,
        out=(z_flxdiv_mass, z_flxdiv_theta, z_w_expl, z_contr_w_fl_l, z_beta, z_alpha, z_q, w, z_rho_expl, z_exner_expl, w_prev, z_q_prev, z_a, z_b, z_c, w_prep),
        domain={
    ...
    _w(w_prev, z_q_prev, z_a, z_b, z_c, w_prep, out=(z_q, w, buffer), domain={
            CellDim: (start_cell_nudging, end_cell_local),
            KDim: (vertical_start, vertical_end),
        })

    _solve_tridiagonal_matrix_for_w_back_substitution_scan(z_q=z_q, w=w, out=w, domain={
            CellDim: (start_cell_nudging, end_cell_local),
            KDim: (vertical_start, vertical_end),
        })

    _fused_solve_nonhydro_stencil_41_to_60_predictor_p3(
        geofac_div=geofac_div,
        mass_fl_e=mass_fl_e,
        z_theta_v_fl_e=z_theta_v_fl_e,
        z_flxdiv_mass=z_flxdiv_mass,
