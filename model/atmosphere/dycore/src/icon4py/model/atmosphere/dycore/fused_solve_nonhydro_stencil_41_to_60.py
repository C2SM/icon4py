...
from icon4py.model.atmosphere.dycore.solve_nonhydro_stencils import _stencils_43_44_45, _stencils_42_44_45
...
from icon4py.model.atmosphere.dycore.stencils.apply_rayleigh_damping_mechanism import _apply_rayleigh_damping_mechanism
...
from icon4py.model.atmosphere.dycore.stencils.copy_cell_kdim_field_to_vp import _copy_cell_kdim_field_to_vp
...
from icon4py.model.atmosphere.dycore.stencils.update_mass_volume_flux import _update_mass_volume_flux
...
def _fused_solve_nonhydro_stencil_41_to_60_predictor(
    ...
    z_alpha = where(vert_idx == n_lev,
                    _init_cell_kdim_field_with_zero_vp(), z_alpha)
    ...
    z_rho_expl, z_exner_expl = _add_analysis_increments_from_data_assimilation(
                z_rho_expl=z_rho_expl,
                z_exner_expl=z_exner_expl,
                rho_incr=rho_incr,
...
def _fused_solve_nonhydro_stencil_41_to_60_corrector(
    ...
    mass_flx_ic, vol_flx_ic = _init_two_cell_kdim_fields_with_zero_wp() if (lprep_adv & idyn_timestep) else mass_flx_ic, vol_flx_ic
