...
def _fused_solve_nonhydro_stencil_15_to_28_predictor(
    ...
    geofac_grg_y: gtx.Field[[CellDim, C2E2CODim], float],
    ...
    z_dexner_dz_c_2: gtx.Field[[CellDim, KDim], float],
    z_gradh_exner: gtx.Field[[EdgeDim, KDim], float],
    z_hydro_corr: gtx.Field[[EdgeDim, KDim], float],
...
def _fused_solve_nonhydro_stencil_15_to_28_corrector(
    ...
    z_theta_v_e: gtx.Field[[EdgeDim, KDim], float],
    z_gradh_exner: gtx.Field[[EdgeDim, KDim], float],
    z_graddiv2_vn: gtx.Field[[EdgeDim, KDim], float],
    geofac_grdiv: gtx.Field[[EdgeDim, E2C2EODim], float],
    scal_divdamp: gtx.Field[[KDim], float],
    bdy_divdamp: gtx.Field[[KDim], float],
    nudgecoeff_e: gtx.Field[[EdgeDim], float],
    horz_idx: gtx.Field[[EdgeDim], int32],
    vert_idx: gtx.Field[[KDim], int32],
    wgt_nnow_vel: float,
    wgt_nnew_vel: float,
