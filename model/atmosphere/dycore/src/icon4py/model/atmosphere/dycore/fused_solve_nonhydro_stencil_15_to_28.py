...
from icon4py.model.atmosphere.dycore.compute_graddiv2_of_vn import _compute_graddiv2_of_vn
...
def _fused_solve_nonhydro_stencil_15_to_28_predictor(
    ...
    (z_grad_rth_1, z_grad_rth_2, z_grad_rth_3, z_grad_rth_4,) = _grad_green_gauss_cell(
        p_ccpr1=z_rth_pr_1,
        p_ccpr2=z_rth_pr_2,
...
def _fused_solve_nonhydro_stencil_15_to_28_corrector(
    ...
    vn = (
        ...
        if ((divdamp_order == int32(24)) & (divdamp_fac_o2 <= (4.0 * divdamp_fac)) & limited_area)
        else vn
    )
...
def _fused_solve_nonhydro_stencil_15_to_28(
    ...
    (z_rho_e, z_theta_v_e, z_gradh_exner, vn,) = (
