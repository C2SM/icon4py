...
def _zero_initialize_for_limited_area_mode(
    ...
    (temporal_extrapolation_of_perturbed_exner_, perturbed_exner_at_cells_on_model_levels_) = (
        _init_two_cell_kdim_fields_with_zero_vp()
        if limited_area
        else (temporal_extrapolation_of_perturbed_exner, perturbed_exner_at_cells_on_model_levels)
    )

    return (temporal_extrapolation_of_perturbed_exner_, perturbed_exner_at_cells_on_model_levels_)
...
def _compute_perturbed_quantities_and_interpolation(
    ...
    perturbed_theta_v_at_cells_on_half_levels_ = concat_where(
        dims.KDim == 0,
...
def _set_theta_v_and_exner_on_surface_level(
    ...
    perturbed_theta_v_at_cells_on_half_levels_ = _interpolate_to_surface(
        wgtfacq_c=wgtfacq_c, interpolant=perturbed_theta_v_at_cells_on_model_levels
    )
    theta_v_at_cells_on_half_levels = (
        reference_theta_at_cells_on_half_levels + perturbed_theta_v_at_cells_on_half_levels_
    )
...
def _compute_perturbed_quantities_and_interpolation_wrapper(
    ...
    (temporal_extrapolation_of_perturbed_exner_, exner_at_cells_on_half_levels_) = concat_where(
        ...
        (temporal_extrapolation_of_perturbed_exner_, exner_at_cells_on_half_levels)
    )
