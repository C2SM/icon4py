...
@field_operator
def _apply_hydrostatic_correction_to_horizontal_gradient_of_exner_pressure_original(
...
def apply_hydrostatic_correction_to_horizontal_gradient_of_exner_pressure_original(
    ipeidx_dsl: fa.EdgeKField[bool],
    pg_exdist: fa.EdgeKField[vpfloat],
    z_hydro_corr: gtx.Field[gtx.Dims[dims.EdgeDim], vpfloat],
    z_gradh_exner: fa.EdgeKField[vpfloat],
    ...
    _apply_hydrostatic_correction_to_horizontal_gradient_of_exner_pressure_original(
        ipeidx_dsl,
        pg_exdist,
        z_hydro_corr,
        z_gradh_exner,
