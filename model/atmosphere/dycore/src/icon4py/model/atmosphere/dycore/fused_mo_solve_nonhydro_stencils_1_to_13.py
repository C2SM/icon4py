...
def _fused_mo_solve_nonhydro_stencils_1_to_13_predictor(
    ...
    #             wgtfacq_c_dsl=wgtfacq_c_dsl, z_exner_ex_pr=z_exner_ex_pr
    #         ),
    #     )
    #     if igradp_method == 3
    #     else z_exner_ic
    ...
    #         ),
    #         _interpolate_to_half_levels_vp(
    #             wgtfac_c=wgtfac_c, z_exner_ex_pr=z_exner_ex_pr, z_exner_ic=z_exner_ic
    #         ),
    #     )
    #     if igradp_method == 3
    #     else z_exner_ic
    # )
    # TODO: interpolation fields
...
def _fused_mo_solve_nonhydro_stencils_1_to_13(
    ...
    (rho_ic, z_theta_v_pr_ic, theta_v_ic, z_th_ddz_exner_c) = (
        ...
        if istep == 2
        else (rho_ic, z_theta_v_pr_ic, theta_v_ic, z_th_ddz_exner_c)
    )
