...
def _compute_contravariant_correction_of_w_for_lower_boundary(
    ...
    z_w_concorr_me_offset_1 = z_w_concorr_me_wp(KHalfDim - 0.5)
    z_w_concorr_me_offset_2 = z_w_concorr_me_wp(KHalfDim - 1.5)
    z_w_concorr_me_offset_3 = z_w_concorr_me_wp(KHalfDim - 2.5)
    ...
    w_concorr_c_vp = (
        wgtfacq_c(KHalfDim - 0.5) * z_w_concorr_mc_m1_vp
        + wgtfacq_c(KHalfDim - 1.5) * z_w_concorr_mc_m2_vp
        + wgtfacq_c(KHalfDim - 2.5) * z_w_concorr_mc_m3_vp
    )
