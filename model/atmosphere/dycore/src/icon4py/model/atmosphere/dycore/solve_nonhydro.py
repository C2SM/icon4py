...
class SolveNonhydro:
    ...
    def run_predictor_step(
        ...
        self._compute_theta_rho_face_values_and_pressure_gradient_and_update_vn_in_predictor_step(
            ...
            tangential_wind=diagnostic_state_nh.vt,
            ...
            predictor_normal_wind_advective_tendency=diagnostic_state_nh.ddt_vn_apc_pc.predictor,
    ...
    def run_corrector_step(
        ...
        self._apply_divergence_damping_and_update_vn_in_corrector_step(
            ...
            predictor_normal_wind_advective_tendency=diagnostic_state_nh.ddt_vn_apc_pc.predictor,
            corrector_normal_wind_advective_tendency=diagnostic_state_nh.ddt_vn_apc_pc.corrector,
            normal_wind_tendency_due_to_physics_process=diagnostic_state_nh.normal_wind_tendency_due_to_physics_process,
            normal_wind_iau_increments=diagnostic_state_nh.normal_wind_iau_increments,
            theta_v_at_edges_on_model_levels=z_fields.theta_v_at_edges_on_model_levels,
            horizontal_pressure_gradient=z_fields.horizontal_pressure_gradient,
