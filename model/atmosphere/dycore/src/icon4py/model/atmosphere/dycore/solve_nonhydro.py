...
class SolveNonhydro:
    ...
    def run_predictor_step(
        ...
        self._fused_solve_nonhydro_stencil_41_to_60_predictor(
            ...
            diagnostic_state_nh.exner_dyn_incr,
            self._interpolation_state.geofac_div,
            diagnostic_state_nh.mass_fl_e,
            self.z_theta_v_fl_e,
            diagnostic_state_nh.vertical_wind_advective_tendency.predictor,
            self.z_th_ddz_exner_c,
            diagnostic_state_nh.rho_ic,
            diagnostic_state_nh.contravariant_correction_at_cells_on_half_levels,
            self._metric_state_nonhydro.vwind_expl_wgt,
            prognostic_states.current.exner,
            prognostic_states.current.rho,
            prognostic_states.current.theta_v,
            prognostic_states.current.w,
            self._metric_state_nonhydro.inv_ddqz_z_full,
            self._metric_state_nonhydro.vwind_impl_wgt,
            diagnostic_state_nh.theta_v_at_cells_on_half_levels,
            diagnostic_state_nh.exner_pr,
            diagnostic_state_nh.ddt_exner_phy,
            diagnostic_state_nh.rho_incr,
            diagnostic_state_nh.exner_incr,
            self._metric_state_nonhydro.ddqz_z_half,
            self.z_raylfac,
            self._metric_state_nonhydro.exner_ref_mc,
            constants.CVD_O_RD,
            ...
            constants.CVD,
            constants.CPD,
            constants.RayleighType.KLEMP.value,
            self.l_vert_nested,
            self._config.is_iau_active,
            constants.RayleighType.KLEMP,
            self._config.divdamp_type,
            at_first_substep,
            self._vertical_params.end_index_of_damping_layer,
            self._grid.num_levels,
            self.jk_start,
            self._params.starting_vertical_index_for_3d_divdamp,
            self._vertical_params.kstart_moist,
            self._start_cell_nudging,
            self._end_cell_local,
            gtx.int32(0),
