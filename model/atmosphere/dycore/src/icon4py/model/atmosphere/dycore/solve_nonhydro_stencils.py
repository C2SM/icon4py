...
def stencils_42_44_45_45b(
    ...
    ddt_w_adv_ntl1: fa.CellKField[ta.wpfloat],
    ddt_w_adv_ntl2: fa.CellKField[ta.wpfloat],
    ...
    z_beta: fa.CellKField[ta.wpfloat],
...
def stencils_47_48_49(
    w_nnew: fa.CellKField[ta.wpfloat],
    z_contr_w_fl_l: fa.CellKField[ta.wpfloat],
    w_concorr_c: fa.CellKField[ta.wpfloat],
    ...
    theta_v_ic: fa.CellKField[ta.wpfloat],
    ddt_exner_phy: fa.CellKField[ta.wpfloat],
    dtime: ta.wpfloat,
    horizontal_start: gtx.int32,
    horizontal_end: gtx.int32,
    vertical_end: gtx.int32,
