...
@field_operator
def _apply_4th_order_divergence_damping_nonmeancell(
    scal_divdamp: Field[[KDim], wpfloat],
    z_graddiv2_vn: Field[[EdgeDim, KDim], vpfloat],
    edge_areas: Field[[EdgeDim], wpfloat],
    ...
    vn_wp = vn + (scal_divdamp * z_graddiv2_vn_wp * edge_areas**2)
    return vn_wp


@program(grid_type=GridType.UNSTRUCTURED, backend=backend)
def apply_4th_order_divergence_damping_nonmeancell(
    scal_divdamp: Field[[KDim], wpfloat],
    z_graddiv2_vn: Field[[EdgeDim, KDim], vpfloat],
    edge_areas: Field[[EdgeDim], wpfloat],
    vn: Field[[EdgeDim, KDim], wpfloat],
    ...
    _apply_4th_order_divergence_damping_nonmeancell(
        scal_divdamp,
        z_graddiv2_vn,
        edge_areas,
        vn,
