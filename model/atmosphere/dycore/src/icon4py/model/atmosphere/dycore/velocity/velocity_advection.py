...
class VelocityAdvection:
    ...
    def run_predictor_step(
        ...
        #self.stencil_mo_math_divrot_rot_vertex_ri_dsl(
            ...
            vertical_start=0,
            vertical_end=self.grid.num_levels,
            offset_provider=self.grid.offset_providers,#self.offset_provider_v2e,
        )
        ...
        compute_tangential_wind(
            ...
            vertical_start=0,
            vertical_end=self.grid.num_levels,
            offset_provider=self.grid.offset_providers,#self.offset_provider_e2c2e,
        )
        ...
        if not vn_only:
            ...
            compute_horizontal_advection_term_for_vertical_velocity(
                ...
                vertical_start=0,
                vertical_end=self.grid.num_levels,
                offset_provider=self.grid.offset_providers,#self.offset_provider_e2c_e2v,
            )
        ...
        velocity_prog.fused_stencils_9_10(
            ...
            vertical_start=0,
            vertical_end=self.grid.num_levels,
            offset_provider=self.grid.offset_providers,#self.offset_provider_c2e_c2ce_koff,
        )
        ...
        compute_advective_normal_wind_tendency(
            ...
            vertical_start=0,
            vertical_end=self.grid.num_levels,
            offset_provider=self.grid.offset_providers,#self.offset_provider_e2c_e2v_e2ec_koff,
        )
        ...
        add_extra_diffusion_for_wn_approaching_cfl(
            ...
            offset_provider=self.grid.offset_providers,#self.offset_provider_e2c_e2v_e2c2eo_koff,
        )
