...
class GraupelFunctionConstants(FrozenNamespace):
    ...
    cvd = phy_const.CPD - phy_const.RD
    #: [K*kg/J]
    rcpd = 1.0 / phy_const.CPD
    #: [K*kg/J]"""
    rcvd = 1.0 / cvd
    #: cp_d / cp_l - 1
    rcpl = 3.1733
    ...
    c5alvcp = c5les * alv / phy_const.CPD
    c5alscp = c5ies * als / phy_const.CPD
    alvdcp = alv / phy_const.CPD
    alsdcp = als / phy_const.CPD

    #: latent heat of fusion for water [J/kg]
    alf = als - alv
    #: Specific heat capacity of liquid water
    clw = (rcpl + 1.0) * phy_const.CPD

    pvsw0 = c1es * np.exp(c3les * (tmelt - tmelt) / (tmelt - c4les))
    ...
    GrFuncConst_c5les   = GrFuncConst_c3les*(tmelt - GrFuncConst_c4les)      # = b234w
    GrFuncConst_c5ies   = GrFuncConst_c3ies*(tmelt - GrFuncConst_c4ies)      # = b234i
    GrFuncConst_c5alvcp = GrFuncConst_c5les*alv/phy_const.CPD            #
    GrFuncConst_c5alscp = GrFuncConst_c5ies*als/phy_const.CPD            #
    GrFuncConst_alvdcp  = alv/phy_const.CPD                          #
    GrFuncConst_alsdcp  = als/phy_const.CPD                          #
...
def fpvsw(
   ...
   return graupel_funcConst.GrFuncConst_c1es * numpy_exp(
      graupel_funcConst.GrFuncConst_c3les * (ztx - graupel_funcConst.tmelt) / (ztx - graupel_funcConst.GrFuncConst_c4les)
   )
...
def fxna(
   ...
   return 1.0e2 * numpy_exp(0.2 * (graupel_funcConst.tmelt - ztx))
...
def fxna_cooper(
   ...
   return 5.0 * numpy_exp(0.304 * (graupel_funcConst.tmelt - ztx))
...
class GraupelGlobalConstants(FrozenNamespace):
   ...
   GrConst_nimix = 5.0 * numpy_exp(0.304 * (graupel_funcConst.tmelt - GrConst_tmix))
   #else:
   ...
   GrConst_ccsrim = 0.25 * math.pi * GrConst_ecs * GrConst_v0snow * gamma_fct(GrConst_v1s + 3.0)
   GrConst_ccsagg = 0.25 * math.pi * GrConst_v0snow * gamma_fct(GrConst_v1s + 3.0)
   ...
   GrConst_ccshi1 = graupel_funcConst.als * graupel_funcConst.als / (GrConst_lheat * phy_const.RV)
   GrConst_ccdvtp = 2.22e-5 * graupel_funcConst.tmelt**(-1.94) * 101325.0
   ...
   GrConst_pvsw0 = fpvsw(graupel_funcConst.tmelt)  # sat. vap. pressure for t = t0
   ...
   GrConst_ar    = math.pi * GrConst_rhow / 6.0 * GrConst_n0r * gamma_fct(GrConst_mu_rain + 4.0)      # pre-factor
   ...
   GrConst_cev   = 2.0 * math.pi * GrConst_dv / GrConst_hw * GrConst_n0r*GrConst_ar**(-GrConst_cevxp) * gamma_fct(GrConst_mu_rain + 2.0)
...
def _fxna(
   ...
   # Return number of activate ice crystals from temperature
   return 1.0e2 * exp(0.2 * (graupel_funcConst.tmelt - ztx))
...
def _fxna_cooper(
   ...
   return 5.0 * exp(0.304 * (graupel_funcConst.tmelt - ztx))
...
def latent_heat_vaporization(
   ...
   return (
      graupel_funcConst.alv
      + (graupel_const.GrConst_cp_v - graupel_funcConst.clw) * (input_t - graupel_funcConst.tmelt)
      - graupel_funcConst.rv * input_t
   )
...
def latent_heat_sublimation(
   ...
   return(
      graupel_funcConst.als + (graupel_const.GrConst_cp_v - graupel_const.GrConst_ci) * (input_t - graupel_funcConst.tmelt) - graupel_funcConst.rv * input_t
   )
...
def sat_pres_water(
   ...
   # Tetens formula
   return (
      graupel_funcConst.GrFuncConst_c1es * exp( graupel_funcConst.GrFuncConst_c3les * (input_t - graupel_funcConst.tmelt) / (input_t - graupel_funcConst.GrFuncConst_c4les) )
   )
...
def sat_pres_ice(
   ...
   # Tetens formula
   return (
      graupel_funcConst.GrFuncConst_c1es * exp( graupel_funcConst.GrFuncConst_c3ies * (input_t - graupel_funcConst.tmelt) / (input_t - graupel_funcConst.GrFuncConst_c4ies) )
   )
...
def _graupel_scan(
    ...
    Cheat_cap_r = graupel_funcConst.rcvd if ( l_cv ) else graupel_funcConst.rcpd
    ...
    CLHv = graupel_funcConst.alv + (graupel_const.GrConst_cp_v - graupel_funcConst.clw) * (temperature - graupel_funcConst.tmelt) - graupel_funcConst.rv * temperature if (ithermo_water != 0) else graupel_funcConst.alv
    CLHs = graupel_funcConst.als + (graupel_const.GrConst_cp_v - graupel_const.GrConst_ci) * (temperature - graupel_funcConst.tmelt) - graupel_funcConst.rv * temperature if (ithermo_water != 0) else graupel_funcConst.als
    ...
    if (llqs):
        ...
        if ( graupel_const.GrConst_isnow_n0temp == 1 ):
            ...
            local_tc = temperature - graupel_funcConst.tmelt
    ...
    if ( graupel_const.GrConst_lsuper_coolw ):
        ...
        Cnin = 5.0 * exp(0.304 * (graupel_funcConst.tmelt - temperature))
        Cnin = minimum( Cnin , graupel_const.GrConst_nimax )
    else:
        # function called: Cnin = _fxna(temperature)
        Cnin = 1.0e2 * exp(0.2 * (graupel_funcConst.tmelt - temperature))
        Cnin = minimum( Cnin , graupel_const.GrConst_nimax )
    Cmi = minimum( rho * qi / Cnin , graupel_const.GrConst_mimax )
    Cmi = maximum( graupel_const.GrConst_mi0 , Cmi )

    # function called: Cqvsw = sat_pres_water(temperature) / (rho * graupel_funcConst.rv * temperature)
    # function called: Cqvsi = sat_pres_ice(temperature) / (rho * graupel_funcConst.rv * temperature)
    Cqvsw = graupel_funcConst.GrFuncConst_c1es * exp( graupel_funcConst.GrFuncConst_c3les * (temperature - graupel_funcConst.tmelt) / (temperature - graupel_funcConst.GrFuncConst_c4les) ) / (rho * graupel_funcConst.rv * temperature)
    Cqvsi = graupel_funcConst.GrFuncConst_c1es * exp( graupel_funcConst.GrFuncConst_c3ies * (temperature - graupel_funcConst.tmelt) / (temperature - graupel_funcConst.GrFuncConst_c4ies) ) / (rho * graupel_funcConst.rv * temperature)
    llqr = True if (rhoqr > graupel_const.GrConst_qmin) else False
    llqs = True if (rhoqs > graupel_const.GrConst_qmin) else False
    llqg = True if (rhoqg > graupel_const.GrConst_qmin) else False
    ...
    if ( llqc & (temperature > graupel_const.GrConst_thn) ):
        ...
        if ( temperature >= graupel_funcConst.tmelt ):
    ...
    if ( graupel_const.GrConst_lred_depgrow & llqc ):
        if ((k_lev > kstart_moist) & (k_lev < kend)):
            ...
            Cnin_cooper = 5.0 * exp(0.304 * (graupel_funcConst.tmelt - temperature))
    ...
    #local_eff = 0.0
    if ( (temperature <= graupel_funcConst.tmelt) & llqi ):
        ...
        if ( graupel_const.GrConst_lstickeff ):
            local_eff = minimum( exp(0.09 * (temperature - graupel_funcConst.tmelt)) , 1.0 )
    ...
    if ( llqi | llqs | llqg ):
        ...
        if ( temperature > graupel_funcConst.tmelt ):
            ...
            local_qvsw0     = graupel_const.GrConst_pvsw0 / (rho * graupel_funcConst.rv * graupel_funcConst.tmelt)
            ...
            if ( temperature > graupel_funcConst.tmelt - graupel_funcConst.GrFuncConst_tcrit * local_qvsw0diff ):
                #calculate melting rate
                local_x1  = temperature - graupel_funcConst.tmelt + graupel_funcConst.GrFuncConst_asmel * local_qvsw0diff
                ...
                #local_qvsw      = sat_pres_water(input_t) / (input_rho * graupel_funcConst.rv * input_t)
    ...
    if ( llqr & (qv + qc <= Cqvsw) ):
        ...
        local_temp_c  = temperature - graupel_funcConst.tmelt
    ...
    if ( llqi | llqs | llqg ):
        if (temperature <= graupel_funcConst.tmelt):  # cold case
