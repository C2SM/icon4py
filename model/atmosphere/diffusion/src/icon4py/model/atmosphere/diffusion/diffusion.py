...
from icon4py.model.common.interpolation.stencils.rbf_vec_interpol_edge2vertex import (
    rbf_vec_interpol_edge2vertex,
)
...
class Diffusion:
    ...
    def __init__(self, exchange: ExchangeRuntime = SingleNodeExchange()):
        ...
        self.stencil_rbf_vec_interpol_edge2vertex = (
            rbf_vec_interpol_edge2vertex.with_backend(backend)
        )
    ...
    def _do_diffusion_step(
        ...
        calculate_nabla2_and_smag_coefficients_for_vn(
            ...
            vertical_start=0,
            vertical_end=klevels,
            offset_provider=self.grid.offset_providers,#self.offset_provider_e2c2v_e2ecv,
        )
