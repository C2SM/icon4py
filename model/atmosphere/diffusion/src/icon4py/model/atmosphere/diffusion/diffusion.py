...
class DiffusionConfig:
    ...
    def __init__(
        ...
        velocity_boundary_diffusion_denom: wpfloat | float = 200.0,  # denom_diffu_v
        temperature_boundary_diffusion_denom: wpfloat | float = 135.0,  # denom_diffu_t
        ...
        nudging_decay_rate: wpfloat | float = 2.0,
