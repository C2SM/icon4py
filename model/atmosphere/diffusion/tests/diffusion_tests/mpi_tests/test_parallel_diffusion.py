...
def test_parallel_diffusion(
    ...
    print(
        f"rank={processor_props.rank}/{processor_props.comm_size}: using local grid with {icon_grid.n_cells()} Cells, {icon_grid.n_edges()} Edges, {icon_grid.n_vertices()} Vertices"
    )
