...
def _get_or_initialize(experiment, backend, name):
    ...
    if not grid_functionality[experiment].get(name):
        ...
        edge_params = grid_states.EdgeParams(
            ...
            primal_normal_vert_x=data_allocation.as_1D_sparse_field(
                geometry_.get(geometry_meta.EDGE_NORMAL_VERTEX_U), target_dim=dims.ECVDim
            ),
            primal_normal_vert_y=data_allocation.as_1D_sparse_field(
            ...
            dual_normal_vert_x=data_allocation.as_1D_sparse_field(
                geometry_.get(geometry_meta.EDGE_TANGENT_VERTEX_U), target_dim=dims.ECVDim
            ),
            dual_normal_vert_y=data_allocation.as_1D_sparse_field(
...
def test_diffusion_init(
    ...
    interpolation_state = diffusion_states.DiffusionInterpolationState(
        e_bln_c_s=data_allocation.as_1D_sparse_field(interpolation_savepoint.e_bln_c_s(), dims.CEDim),
        rbf_coeff_1=interpolation_savepoint.rbf_vec_coeff_v1(),
        rbf_coeff_2=interpolation_savepoint.rbf_vec_coeff_v2(),
        geofac_div=data_allocation.as_1D_sparse_field(interpolation_savepoint.geofac_div(), dims.CEDim),
