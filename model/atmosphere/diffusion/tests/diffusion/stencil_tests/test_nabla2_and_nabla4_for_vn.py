...
def nabla2_and_nabla4_for_vn_numpy(
    *,
    area_edge,
    kh_smag_e,
    z_nabla2_e,
...
class TestNabla2AndNabla4ForVn(stencil_tests.StencilTest):
    PROGRAM = nabla2_and_nabla4_for_vn
    OUTPUTS = ("vn",)
    ...
    def reference(
        ...
        **kwargs,
        ...
        vn = nabla2_and_nabla4_for_vn_numpy(
            area_edge=area_edge,
            kh_smag_e=kh_smag_e,
            z_nabla2_e=z_nabla2_e,
            z_nabla4_e2=z_nabla4_e2,
