...
class TestPrepareNumericalQuadratureForCubicReconstruction(stencil_tests.StencilTest):
    ...
    def _compute_vector_sums(
        *,
        wgt_t_detjac_1: np.ndarray,
        wgt_t_detjac_2: np.ndarray,
        wgt_t_detjac_3: np.ndarray,
        wgt_t_detjac_4: np.ndarray,
        z_gauss_pts_1_x: np.ndarray,
        z_gauss_pts_1_y: np.ndarray,
        z_gauss_pts_2_x: np.ndarray,
        z_gauss_pts_2_y: np.ndarray,
        z_gauss_pts_3_x: np.ndarray,
        z_gauss_pts_3_y: np.ndarray,
        z_gauss_pts_4_x: np.ndarray,
        z_gauss_pts_4_y: np.ndarray,
    ) -> tuple[
        np.ndarray,
        np.ndarray,
        np.ndarray,
