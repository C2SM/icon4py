...
from icon4py.model.atmosphere.tracer_advection.stencils.reconstruct_cubic_coefficients_svd import (
...
class TestReconstructCubicCoefficientsSvd(stencil_tests.StencilTest):
    ...
    def input_data(data_alloc: stencil_tests.DataAllocationWrapper, grid: base.Grid) -> dict:
        ...
        lsq_pseudoinv_1_field = data_alloc.random_field(dims.CellDim, dims.C2E2C2E2CDim)
        lsq_pseudoinv_2_field = data_alloc.random_field(dims.CellDim, dims.C2E2C2E2CDim)
        lsq_pseudoinv_3_field = data_alloc.random_field(dims.CellDim, dims.C2E2C2E2CDim)
        lsq_pseudoinv_4_field = data_alloc.random_field(dims.CellDim, dims.C2E2C2E2CDim)
        lsq_pseudoinv_5_field = data_alloc.random_field(dims.CellDim, dims.C2E2C2E2CDim)
        lsq_pseudoinv_6_field = data_alloc.random_field(dims.CellDim, dims.C2E2C2E2CDim)
        lsq_pseudoinv_7_field = data_alloc.random_field(dims.CellDim, dims.C2E2C2E2CDim)
        lsq_pseudoinv_8_field = data_alloc.random_field(dims.CellDim, dims.C2E2C2E2CDim)
        lsq_pseudoinv_9_field = data_alloc.random_field(dims.CellDim, dims.C2E2C2E2CDim)

        lsq_moments_1 = data_alloc.random_field(dims.CellDim)
        lsq_moments_2 = data_alloc.random_field(dims.CellDim)
        lsq_moments_3 = data_alloc.random_field(dims.CellDim)
        lsq_moments_4 = data_alloc.random_field(dims.CellDim)
        lsq_moments_5 = data_alloc.random_field(dims.CellDim)
        lsq_moments_6 = data_alloc.random_field(dims.CellDim)
        lsq_moments_7 = data_alloc.random_field(dims.CellDim)
        lsq_moments_8 = data_alloc.random_field(dims.CellDim)
        lsq_moments_9 = data_alloc.random_field(dims.CellDim)
        p_coeff_1_dsl = data_alloc.zero_field(dims.CellDim, dims.KDim)
        p_coeff_2_dsl = data_alloc.zero_field(dims.CellDim, dims.KDim)
        p_coeff_3_dsl = data_alloc.zero_field(dims.CellDim, dims.KDim)
        p_coeff_4_dsl = data_alloc.zero_field(dims.CellDim, dims.KDim)
        p_coeff_5_dsl = data_alloc.zero_field(dims.CellDim, dims.KDim)
        p_coeff_6_dsl = data_alloc.zero_field(dims.CellDim, dims.KDim)
        p_coeff_7_dsl = data_alloc.zero_field(dims.CellDim, dims.KDim)
        p_coeff_8_dsl = data_alloc.zero_field(dims.CellDim, dims.KDim)
        p_coeff_9_dsl = data_alloc.zero_field(dims.CellDim, dims.KDim)
        p_coeff_10_dsl = data_alloc.zero_field(dims.CellDim, dims.KDim)
