...
class TestPrepareNumericalQuadratureListForCubicReconstruction(stencil_tests.StencilTest):
    ...
    def input_data(data_alloc: stencil_tests.DataAllocationWrapper, grid: base.Grid) -> dict:
        famask_int = data_alloc.constant_field(1, dims.EdgeDim, dims.KDim, dtype=gtx.int32)
        ...
        p_dreg_area_in = data_alloc.random_field(dims.EdgeDim, dims.KDim)
        ...
        p_dreg_area = data_alloc.zero_field(dims.EdgeDim, dims.KDim)
