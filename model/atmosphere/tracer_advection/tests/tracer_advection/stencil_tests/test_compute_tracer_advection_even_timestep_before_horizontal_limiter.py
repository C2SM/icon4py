...
"""Tests for the fused even-timestep tracer advection program (before horizontal limiter)."""
...
class TestComputeTracerAdvectionEvenTimestepBeforeHorizontalLimiter(stencil_tests.StencilTest):
    ...
    def reference(
        ...
        **kwargs: Any,
        ...
        # Step 4: 2nd order Miura horizontal flux (ihadv_tracer==2)
        if ihadv_tracer == 2:
        ...
        # Step 5: positive definite limiter factor (itype_hlimit==4)
        if itype_hlimit == 4:
