...
from icon4py.model.atmosphere.tracer_advection.stencils.compute_horizontal_tracer_flux_from_cubic_coefficients import (
...
class TestComputeHorizontalTracerFluxFromCubicCoefficients(stencil_tests.StencilTest):
