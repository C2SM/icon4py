...
class TestPrepareFfslFluxAreaPatchesList(stencil_tests.StencilTest):
    ...
    def input_data(self, grid) -> dict:
        famask_int = data_alloc.random_mask(grid, dims.EdgeDim, KDim, dtype=gtx.int32)
        ...
        dreg_patch0_1_lon_dsl = data_alloc.constant_field(grid, 1.0, dims.EdgeDim, KDim)
        dreg_patch0_1_lat_dsl = data_alloc.constant_field(grid, 1.0, dims.EdgeDim, KDim)
        dreg_patch0_2_lon_dsl = data_alloc.constant_field(grid, 2.0, dims.EdgeDim, KDim)
        dreg_patch0_2_lat_dsl = data_alloc.constant_field(grid, 2.0, dims.EdgeDim, KDim)
        dreg_patch0_3_lon_dsl = data_alloc.constant_field(grid, 3.0, dims.EdgeDim, KDim)
        dreg_patch0_3_lat_dsl = data_alloc.constant_field(grid, 3.0, dims.EdgeDim, KDim)
        dreg_patch0_4_lon_dsl = data_alloc.constant_field(grid, 4.0, dims.EdgeDim, KDim)
        dreg_patch0_4_lat_dsl = data_alloc.constant_field(grid, 4.0, dims.EdgeDim, KDim)
        dreg_patch1_1_lon_vmask = data_alloc.zero_field(grid, dims.EdgeDim, KDim)
        dreg_patch1_1_lat_vmask = data_alloc.zero_field(grid, dims.EdgeDim, KDim)
        dreg_patch1_2_lon_vmask = data_alloc.zero_field(grid, dims.EdgeDim, KDim)
        dreg_patch1_2_lat_vmask = data_alloc.zero_field(grid, dims.EdgeDim, KDim)
        dreg_patch1_3_lon_vmask = data_alloc.zero_field(grid, dims.EdgeDim, KDim)
        dreg_patch1_3_lat_vmask = data_alloc.zero_field(grid, dims.EdgeDim, KDim)
        dreg_patch1_4_lon_vmask = data_alloc.zero_field(grid, dims.EdgeDim, KDim)
        dreg_patch1_4_lat_vmask = data_alloc.zero_field(grid, dims.EdgeDim, KDim)
        dreg_patch2_1_lon_vmask = data_alloc.zero_field(grid, dims.EdgeDim, KDim)
        dreg_patch2_1_lat_vmask = data_alloc.zero_field(grid, dims.EdgeDim, KDim)
        dreg_patch2_2_lon_vmask = data_alloc.zero_field(grid, dims.EdgeDim, KDim)
        dreg_patch2_2_lat_vmask = data_alloc.zero_field(grid, dims.EdgeDim, KDim)
        dreg_patch2_3_lon_vmask = data_alloc.zero_field(grid, dims.EdgeDim, KDim)
        dreg_patch2_3_lat_vmask = data_alloc.zero_field(grid, dims.EdgeDim, KDim)
        dreg_patch2_4_lon_vmask = data_alloc.zero_field(grid, dims.EdgeDim, KDim)
        dreg_patch2_4_lat_vmask = data_alloc.zero_field(grid, dims.EdgeDim, KDim)
        return dict(
