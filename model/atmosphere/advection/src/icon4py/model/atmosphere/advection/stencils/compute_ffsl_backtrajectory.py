...
def _compute_ffsl_backtrajectory(
    ...
    primal_normal_cell_x: gtx.Field[gtx.Dims[dims.ECDim], wpfloat],
    primal_normal_cell_y: gtx.Field[gtx.Dims[dims.ECDim], wpfloat],
    dual_normal_cell_x: gtx.Field[gtx.Dims[dims.ECDim], wpfloat],
    dual_normal_cell_y: gtx.Field[gtx.Dims[dims.ECDim], wpfloat],
