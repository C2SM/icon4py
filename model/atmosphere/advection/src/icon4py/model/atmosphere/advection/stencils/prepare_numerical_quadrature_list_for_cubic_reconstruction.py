...
def _prepare_numerical_quadrature_list_for_cubic_reconstruction(
    ...
    p_quad_vector_sum_1 = astype(
        (wgt_t_detjac_1 + wgt_t_detjac_2 + wgt_t_detjac_3 + wgt_t_detjac_4), vpfloat
    )
    p_quad_vector_sum_2 = astype(
        (
