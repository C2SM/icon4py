...
@gtx.field_operator
def _prepare_numerical_quadrature_list_for_cubic_reconstruction(
    ...
    p_dreg_area = p_dreg_area_in + astype(p_quad_vector_sum_1, vpfloat)
