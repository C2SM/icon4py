...
from icon4py.model.common.test_utils.helpers import StencilTest, random_field, random_mask, zero_field

class TestUpwindHfluxMiura3Stencil01(StencilTest):
    PROGRAM = upwind_hflux_miura3_stencil_01
    OUTPUTS = ("p_out_e_miura3",)
    ...
    def reference(
        ...
        **kwargs,
        ...
        return dict(p_out_e_miura3=p_out_e_miura3)
    ...
    def input_data(self, grid):
        ...
        return dict(
            ...
            z_quad_vector_sum_2=z_quad_vector_sum_1,
            z_quad_vector_sum_3=z_quad_vector_sum_1,
            z_quad_vector_sum_4=z_quad_vector_sum_1,
            z_quad_vector_sum_5=z_quad_vector_sum_1,
            z_quad_vector_sum_6=z_quad_vector_sum_1,
            z_quad_vector_sum_7=z_quad_vector_sum_1,
            z_quad_vector_sum_8=z_quad_vector_sum_1,
            z_quad_vector_sum_9=z_quad_vector_sum_1,
            z_quad_vector_sum_10=z_quad_vector_sum_1,
            z_dreg_area=z_dreg_area,
            p_mass_flx_e=p_mass_flx_e,
            cell_rel_idx_dsl=cell_rel_idx_dsl,
            p_out_e_miura3=p_out_e_miura3,
        )