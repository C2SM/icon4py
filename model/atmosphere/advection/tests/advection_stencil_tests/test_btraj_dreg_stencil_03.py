...
from icon4py.model.atmosphere.advection.stencils.btraj_dreg_stencil_03 import btraj_dreg_stencil_03
...
class TestBtrajDregStencil03(StencilTest):
    PROGRAM = btraj_dreg_stencil_03
    OUTPUTS = (
        "p_cell_idx",
        "p_cell_rel_idx_dsl",
        "p_cell_blk",
