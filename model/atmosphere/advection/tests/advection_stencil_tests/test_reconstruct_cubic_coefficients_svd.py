...
class TestReconstructCubicCoefficientsSvd(helpers.StencilTest):
    ...
    def reference(
        ...
        **kwargs,
        ...
        lsq_moments_1 = xp.expand_dims(xp.asarray(lsq_moments_1), axis=-1)
        lsq_moments_2 = xp.expand_dims(xp.asarray(lsq_moments_2), axis=-1)
        lsq_moments_3 = xp.expand_dims(xp.asarray(lsq_moments_3), axis=-1)
        lsq_moments_4 = xp.expand_dims(xp.asarray(lsq_moments_4), axis=-1)
        lsq_moments_5 = xp.expand_dims(xp.asarray(lsq_moments_5), axis=-1)
        lsq_moments_6 = xp.expand_dims(xp.asarray(lsq_moments_6), axis=-1)
        lsq_moments_7 = xp.expand_dims(xp.asarray(lsq_moments_7), axis=-1)
        lsq_moments_8 = xp.expand_dims(xp.asarray(lsq_moments_8), axis=-1)
        lsq_moments_9 = xp.expand_dims(xp.asarray(lsq_moments_9), axis=-1)
        ...
        lsq_pseudoinv_9 = xp.expand_dims(xp.asarray(lsq_pseudoinv_9), axis=-1)
        lsq_pseudoinv_8 = helpers.reshape(lsq_pseudoinv_8, c2e2c2e2c.shape)
        lsq_pseudoinv_8 = xp.expand_dims(xp.asarray(lsq_pseudoinv_8), axis=-1)
        lsq_pseudoinv_7 = helpers.reshape(lsq_pseudoinv_7, c2e2c2e2c.shape)
        lsq_pseudoinv_7 = xp.expand_dims(xp.asarray(lsq_pseudoinv_7), axis=-1)
        lsq_pseudoinv_6 = helpers.reshape(lsq_pseudoinv_6, c2e2c2e2c.shape)
        lsq_pseudoinv_6 = xp.expand_dims(xp.asarray(lsq_pseudoinv_6), axis=-1)
        lsq_pseudoinv_5 = helpers.reshape(lsq_pseudoinv_5, c2e2c2e2c.shape)
        lsq_pseudoinv_5 = xp.expand_dims(xp.asarray(lsq_pseudoinv_5), axis=-1)
        lsq_pseudoinv_4 = helpers.reshape(lsq_pseudoinv_4, c2e2c2e2c.shape)
        lsq_pseudoinv_4 = xp.expand_dims(xp.asarray(lsq_pseudoinv_4), axis=-1)
        lsq_pseudoinv_3 = helpers.reshape(lsq_pseudoinv_3, c2e2c2e2c.shape)
        lsq_pseudoinv_3 = xp.expand_dims(xp.asarray(lsq_pseudoinv_3), axis=-1)
        lsq_pseudoinv_2 = helpers.reshape(lsq_pseudoinv_2, c2e2c2e2c.shape)
        lsq_pseudoinv_2 = xp.expand_dims(xp.asarray(lsq_pseudoinv_2), axis=-1)
        lsq_pseudoinv_1 = helpers.reshape(lsq_pseudoinv_1, c2e2c2e2c.shape)
        lsq_pseudoinv_1 = xp.expand_dims(xp.asarray(lsq_pseudoinv_1), axis=-1)
