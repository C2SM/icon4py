...
@gtx.field_operator
def _prepare_tridiagonal_matrix_cells_interior(
    ...
    """
    Interior rows of the full-level tridiagonal diffusion matrix.

    Port of the interior loop of 'prepare_diffusion_matrix_wp' (mo_vdf_atmo.f90)
    with lhalflvl=.FALSE. (lvlcorr_a=0, lvlcorr_c=1):
...
@gtx.field_operator
def _prepare_tridiagonal_matrix_cells_top(
    inv_mair: fa.CellKField[wpfloat],
    inv_dz: fa.CellKField[wpfloat],
    zk: fa.CellKField[wpfloat],
    zprefac: wpfloat,
...
@gtx.field_operator
def _prepare_tridiagonal_matrix_cells_bottom(
    inv_mair: fa.CellKField[wpfloat],
    inv_dz: fa.CellKField[wpfloat],
    zk: fa.CellKField[wpfloat],
    zprefac: wpfloat,
...
def prepare_tridiagonal_matrix_cells(
    inv_mair: fa.CellKField[wpfloat],
    inv_dz: fa.CellKField[wpfloat],
    zk: fa.CellKField[wpfloat],
    ...
    _prepare_tridiagonal_matrix_cells_interior(
        inv_mair=inv_mair,
        inv_dz=inv_dz,
        zk=zk,
        zprefac=zprefac,
    ...
    _prepare_tridiagonal_matrix_cells_top(
        inv_mair=inv_mair,
        inv_dz=inv_dz,
        zk=zk,
        zprefac=zprefac,
    ...
    _prepare_tridiagonal_matrix_cells_bottom(
        inv_mair=inv_mair,
        inv_dz=inv_dz,
        zk=zk,
        zprefac=zprefac,
