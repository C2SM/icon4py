...
class SingleMomentSixClassIconGraupel:
    ...
    def run(
        ...
        rain_evaporation_rate_r2v: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        ice_deposition_rate_v2i: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        snow_deposition_rate_v2s: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        graupel_deposition_rate_v2g: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        ice_nucleation_rate_v2i: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        rain_deposition_rate_v2r: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        ice_melting_rate_i2c: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        cloud_autoconversion_rate_c2r: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        cloud_freezing_rate_c2i: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        rain_cloud_collision_rate_c2r: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        rain_shedding_rate_c2r: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        snow_riming_rate_c2s: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        graupel_riming_rate_c2g: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        rain_ice_2graupel_ice_loss_rate_i2g: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        ice_dep_autoconversion_rate_i2s: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        snow_ice_collision_rate_i2s: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        graupel_ice_collision_rate_i2g: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        ice_autoconverson_rate_i2s: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        snow_melting_rate_s2r: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        graupel_melting_rate_g2r: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        rain_ice_2graupel_rain_loss_rate_r2g: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        rain_freezing_rate_r2g: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
        snow_autoconversion_rate_s2g: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
    ):
        """
...
def _icon_graupel(
    ...
    temperature: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
    pres: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
    rho: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
    qv: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
    qc: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
    qi: gtx.Field[[dims.CellDim, dims.KDim], ta.wpfloat],
