...
class TestSnowToGraupel(StencilTest):
    ...
    def input_data(self, grid):
        ...
        return dict(
            t                = constant_field(grid, 265.85, dims.CellDim, dtype=wpfloat),
            rho              = constant_field(grid, 1.04848, dims.CellDim, dtype=wpfloat),
            qc               = constant_field(grid, 7.02792e-5, dims.CellDim, dtype=wpfloat),
            qs               = constant_field(grid, 4.44664e-7, dims.CellDim, dtype=wpfloat),
