...
class TestIceDepositionNucleation(StencilTest):
    ...
    def input_data(self, grid):
        ...
        return dict(
            t               = constant_field(grid, 160.9, dims.CellDim, dims.KDim, dtype=wpfloat),
            qc              = constant_field(grid, 1.0e-2, dims.CellDim, dims.KDim, dtype=wpfloat),
            ...
            dvsi            = constant_field(grid, 0.0001, dims.CellDim, dims.KDim, dtype=wpfloat),
            dt              = 30.0,
