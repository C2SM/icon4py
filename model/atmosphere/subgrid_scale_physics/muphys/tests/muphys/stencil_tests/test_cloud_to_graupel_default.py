...
class TestCloudToGraupelDefault(StencilTest):
    ...
    def input_data(self, grid):
        return dict(
            ...
            rho=data_alloc.constant_field(grid, 1.24783, dims.CellDim, KDim, dtype=wpfloat),
            qc=data_alloc.zero_field(grid, dims.CellDim, KDim, dtype=wpfloat),
            qg=data_alloc.constant_field(grid, 1.03636e-25, dims.CellDim, KDim, dtype=wpfloat),
