...
class TestVaporXIceDefault(StencilTest):
    ...
    def input_data(self, grid):
        return dict(
            qi=data_alloc.constant_field(grid, 9.53048e-07, dims.CellDim, KDim, dtype=wpfloat),
            mi=data_alloc.constant_field(grid, 1.0e-9, dims.CellDim, KDim, dtype=wpfloat),
            eta=data_alloc.constant_field(grid, 1.90278e-05, dims.CellDim, KDim, dtype=wpfloat),
            dvsi=data_alloc.constant_field(grid, 0.000120375, dims.CellDim, KDim, dtype=wpfloat),
