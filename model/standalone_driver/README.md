...
run_driver ICON4PY_ROOT/configuration_path/ --grid-file-path GRID_FOLDER/icon_grid_0013_R02B04_R.nc --output-path ICON4PY_ROOT/output_path --icon4py-backend gtfn_cpu
```
