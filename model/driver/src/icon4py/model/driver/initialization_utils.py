...
def read_static_fields(
    ...
    if ser_type == SerializationType.SB:
        ...
        solve_nonhydro_metric_state = dycore_states.MetricStateNonHydro(
            ...
            z_nx1_c=metrics_savepoint.z_nx1_c(),
            z_nx2_c=metrics_savepoint.z_nx2_c(),
            z_rbfmat_c=metrics_savepoint.z_rbfmat_c(),
            z_rbfval_c=metrics_savepoint.z_rbfval_c(),
            z_rhs1_c=metrics_savepoint.z_rhs1_c(),
            z_rhs2_c=metrics_savepoint.z_rhs2_c(),
            i_startidx_c=metrics_savepoint.i_startidx_c(),
            i_endidx_c=metrics_savepoint.i_endidx_c(),
            cartesian_center_c_c_x=metrics_savepoint.cartesian_center_c_c_x(),
            cartesian_center_c_c_y=metrics_savepoint.cartesian_center_c_c_y(),
            cartesian_center_c_c_z=metrics_savepoint.cartesian_center_c_c_z(),
            cartesian_center_e_c_x=metrics_savepoint.cartesian_center_e_c_x(),
            cartesian_center_e_c_y=metrics_savepoint.cartesian_center_e_c_y(),
            cartesian_center_e_c_z=metrics_savepoint.cartesian_center_e_c_z(),
            lat_c=metrics_savepoint.lat_c(),
            lon_c=metrics_savepoint.lon_c(),
            primal_cart_normal_c_x=metrics_savepoint.primal_cart_normal_c_x(),
            primal_cart_normal_c_y=metrics_savepoint.primal_cart_normal_c_y(),
            primal_cart_normal_c_z=metrics_savepoint.primal_cart_normal_c_z(),
            rbf_vec_idx_c_c=metrics_savepoint.rbf_vec_idx_c_c(),
            z_dist_c=metrics_savepoint.z_dist_c(),
