...
def initialize_granules(
    *,
    ...
    edge_geometry = grid_states.EdgeParams(
        ...
        primal_normal_vert=(
            geometry_field_source.export_field(geometry_meta.EDGE_NORMAL_VERTEX_U),
            geometry_field_source.export_field(geometry_meta.EDGE_NORMAL_VERTEX_V),
        ),
        dual_normal_vert=(
            geometry_field_source.export_field(geometry_meta.EDGE_TANGENT_VERTEX_U),
            geometry_field_source.export_field(geometry_meta.EDGE_TANGENT_VERTEX_V),
        ),
        primal_normal_cell=(
            geometry_field_source.export_field(geometry_meta.EDGE_NORMAL_CELL_U),
            geometry_field_source.export_field(geometry_meta.EDGE_NORMAL_CELL_V),
        ),
        dual_normal_cell=(
            geometry_field_source.export_field(geometry_meta.EDGE_TANGENT_CELL_U),
            geometry_field_source.export_field(geometry_meta.EDGE_TANGENT_CELL_V),
        ),
        ...
        edge_center=(
            geometry_field_source.export_field(geometry_meta.EDGE_LAT),
            geometry_field_source.export_field(geometry_meta.EDGE_LON),
        ),
        primal_normal=(
            geometry_field_source.export_field(geometry_meta.EDGE_NORMAL_U),
            geometry_field_source.export_field(geometry_meta.EDGE_NORMAL_V),
        ),
