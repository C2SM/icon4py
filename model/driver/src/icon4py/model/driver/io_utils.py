...
from icon4py.model.common.dimension import CellDim, KDim, CEDim
...
def read_static_fields(
    ...
    if ser_type == SerializationType.SB:
        ...
        savepoint = dataprovider.from_interpolation_savepoint()
        ...
        savepoint = dataprovider.from_metrics_savepoint()
        solve_nonhydro_metric_state = MetricStateNonHydro(
            ...
            wgtfacq_e=savepoint.wgtfacq_e_dsl(icon_grid.num_levels),
