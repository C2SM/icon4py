...
def test_configuration_manager_access_component_configs(config: configuration_manager.ConfigurationManager)->None:
...
def test_configuration_manager_access_components_default(config: configuration_manager.ConfigurationManager)->None:

    assert config.default.dycore.ndyn_substep == 5
    assert config.default.dycore.divdamp_type == dycore_states.DivergenceDampingType.THREE_DIMENSIONAL


def test_configuration_manager_resolve_interpolations(config: configuration_manager.ConfigurationManager)->None:
