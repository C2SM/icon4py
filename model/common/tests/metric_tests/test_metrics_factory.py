...
def test_factory(icon_grid, metrics_savepoint):
    ...
    rayleigh_w_full = factory.get(
        "rayleigh_w", states_factory.RetrievalType.FIELD
    )
    ...
    coeff1_dwdz_full = factory.get(
        "coeff1_dwdz_full", states_factory.RetrievalType.FIELD
    )
    coeff2_dwdz_full = factory.get(
        "coeff2_dwdz_full", states_factory.RetrievalType.FIELD
    )
    ...
    d2dexdz2_fac1_mc_full = factory.get(
        "d2dexdz2_fac1_mc", states_factory.RetrievalType.FIELD
    )
    d2dexdz2_fac2_mc_full = factory.get(
        "d2dexdz2_fac2_mc", states_factory.RetrievalType.FIELD
    )
    ...
    ddxt_z_half_e_full = factory.get(
        "ddxt_z_half_e", states_factory.RetrievalType.FIELD
    )
    ...
    mask_prog_halo_c_full = factory.get(
        "mask_prog_halo_c", states_factory.RetrievalType.FIELD
    )
    ...
    bdy_halo_c_full = factory.get(
        "bdy_halo_c", states_factory.RetrievalType.FIELD
    )
    assert helpers.dallclose(bdy_halo_c_full.asnumpy(), bdy_halo_c_ref.asnumpy())

    hmask_dd3d_ref = metrics_savepoint.mask_prog_halo_c()
    hmask_dd3d_full = factory.get(
        "hmask_dd3d", states_factory.RetrievalType.FIELD
    )
