...
def test_factory_inv_ddqz_z(
    ...
    factory = get_metrics_factory(backend=backend,
...
@pytest.mark.parametrize(
    ...
    [
        (dt_utils.REGIONAL_EXPERIMENT, dt_utils.REGIONAL_EXPERIMENT),
        # (dt_utils.R02B04_GLOBAL, dt_utils.GLOBAL_EXPERIMENT), # TODO: check why global does not validate
    ],
)
@pytest.mark.datatest
...
@pytest.mark.parametrize(
    "grid_file, experiment",
    [
        #(dt_utils.REGIONAL_EXPERIMENT, dt_utils.REGIONAL_EXPERIMENT), # TODO: check vwind_offctr value for regional
        (dt_utils.R02B04_GLOBAL, dt_utils.GLOBAL_EXPERIMENT),
    ],
)
@pytest.mark.datatest
