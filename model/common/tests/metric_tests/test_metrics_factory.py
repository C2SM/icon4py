...
def test_factory_inv_ddqz_z(
    ...
    factory.get("height_on_interface_levels", state_utils.RetrievalType.FIELD)
    factory.get(INTERFACE_LEVEL_STANDARD_NAME, state_utils.RetrievalType.FIELD)

    inv_ddqz_full_ref = metrics_savepoint.inv_ddqz_z_full()
    inv_ddqz_z_full = factory.get("inv_ddqz_z_full", state_utils.RetrievalType.FIELD)
...
def test_factory_ddq_z_half(
    ...
    factory.get("height_on_interface_levels", state_utils.RetrievalType.FIELD)
    factory.get("height", state_utils.RetrievalType.FIELD)
    factory.get(INTERFACE_LEVEL_STANDARD_NAME, state_utils.RetrievalType.FIELD)

    ddq_z_half_ref = metrics_savepoint.ddqz_z_half()
    # check TODOs in stencil
    ddqz_z_half_full = factory.get(
        "functional_determinant_of_metrics_on_interface_levels", state_utils.RetrievalType.FIELD
    )
...
def test_factory_scalfac_dd3d(
    ...
    scalfac_dd3d_full = factory.get("scalfac_dd3d", state_utils.RetrievalType.FIELD)
...
def test_factory_rayleigh_w(
    ...
    rayleigh_w_full = factory.get("rayleigh_w", state_utils.RetrievalType.FIELD)
...
def test_factory_coeffs_dwdz(
    ...
    coeff1_dwdz_full = factory.get("coeff1_dwdz", state_utils.RetrievalType.FIELD)
    coeff2_dwdz_full = factory.get("coeff2_dwdz", state_utils.RetrievalType.FIELD)
...
def test_factory_ref_mc(
    ...
    theta_ref_mc_full = factory.get("theta_ref_mc", state_utils.RetrievalType.FIELD)
    exner_ref_mc_full = factory.get("exner_ref_mc", state_utils.RetrievalType.FIELD)
...
def test_factory_facs_mc(
    ...
    factory.get("height", state_utils.RetrievalType.FIELD)
    factory.get("inv_ddqz_z_full", state_utils.RetrievalType.FIELD)
    factory.get("theta_ref_mc", state_utils.RetrievalType.FIELD)
    factory.get("exner_ref_mc", state_utils.RetrievalType.FIELD)

    d2dexdz2_fac1_mc_ref = metrics_savepoint.d2dexdz2_fac1_mc()
    d2dexdz2_fac2_mc_ref = metrics_savepoint.d2dexdz2_fac2_mc()
    d2dexdz2_fac1_mc_full = factory.get("d2dexdz2_fac1_mc", state_utils.RetrievalType.FIELD)
    d2dexdz2_fac2_mc_full = factory.get("d2dexdz2_fac2_mc", state_utils.RetrievalType.FIELD)
...
def test_factory_ddxn_z_full(
    ...
    vertical_grid = v_grid.VerticalGrid(v_grid.VerticalGridConfig(num_levels), vct_a, vct_b)
    factory.with_grid(icon_grid, vertical_grid).with_backend(backend)
    factory.get("ddxn_z_half_e", state_utils.RetrievalType.FIELD)

    ddxn_z_full_ref = metrics_savepoint.ddxn_z_full()
    ddxn_z_full = factory.get("ddxn_z_full", state_utils.RetrievalType.FIELD)
...
def test_factory_vwind_impl_wgt(
    ...
    factory.get("ddxn_z_half_e", state_utils.RetrievalType.FIELD)
    factory.get("ddxt_z_half_e", state_utils.RetrievalType.FIELD)
    factory.get("height_on_interface_levels", state_utils.RetrievalType.FIELD)
    factory.get("dual_edge_length", state_utils.RetrievalType.FIELD)

    vwind_impl_wgt_ref = metrics_savepoint.vwind_impl_wgt()
    vwind_impl_wgt_full = factory.get("vwind_impl_wgt", state_utils.RetrievalType.FIELD)
...
def test_factory_vwind_expl_wgt(
    ...
    vertical_grid = v_grid.VerticalGrid(v_grid.VerticalGridConfig(num_levels), vct_a, vct_b)
    factory.with_grid(icon_grid, vertical_grid).with_backend(backend)
    factory.get("vwind_impl_wgt", state_utils.RetrievalType.FIELD)

    vwind_expl_wgt_ref = metrics_savepoint.vwind_expl_wgt()
    vwind_expl_wgt_full = factory.get("vwind_expl_wgt", state_utils.RetrievalType.FIELD)
...
def test_factory_exner_exfac(
    ...
    factory.get("ddxn_z_full", state_utils.RetrievalType.FIELD)
    factory.get("dual_edge_length", state_utils.RetrievalType.FIELD)

    exner_exfac_ref = metrics_savepoint.exner_exfac()
    exner_exfac_full = factory.get("exner_exfac", state_utils.RetrievalType.FIELD)
...
def test_factory_pg_edgeidx_dsl(
    ...
    factory.get("pg_edgeidx", state_utils.RetrievalType.FIELD)
    factory.get("pg_vertidx", state_utils.RetrievalType.FIELD)

    pg_edgeidx_dsl_ref = metrics_savepoint.pg_edgeidx_dsl()
    pg_edgeidx_dsl_full = factory.get("pg_edgeidx_dsl", state_utils.RetrievalType.FIELD)
...
def test_factory_pg_exdist_dsl(
    ...
    factory.get("z_ifc_sliced", state_utils.RetrievalType.FIELD)
    factory.get("height", state_utils.RetrievalType.FIELD)
    factory.get("cell_to_edge_interpolation_coefficient", state_utils.RetrievalType.FIELD)
    factory.get("e_owner_mask", state_utils.RetrievalType.FIELD)
    factory.get("flat_idx_max", state_utils.RetrievalType.FIELD)
    factory.get(INTERFACE_LEVEL_STANDARD_NAME, state_utils.RetrievalType.FIELD)
    factory.get("e_lev", state_utils.RetrievalType.FIELD)

    pg_exdist_dsl_ref = metrics_savepoint.pg_exdist()
    pg_exdist_dsl_full = factory.get("pg_exdist_dsl", state_utils.RetrievalType.FIELD)
...
def test_factory_mask_bdy_prog_halo_c(
    ...
    factory.get("c_refin_ctrl", state_utils.RetrievalType.FIELD)

    mask_prog_halo_c_ref = metrics_savepoint.mask_prog_halo_c()
    mask_prog_halo_c_full = factory.get("mask_prog_halo_c", state_utils.RetrievalType.FIELD)
    bdy_halo_c_ref = metrics_savepoint.bdy_halo_c()
    bdy_halo_c_full = factory.get("bdy_halo_c", state_utils.RetrievalType.FIELD)
...
def test_factory_hmask_dd3d(
    ...
    factory.get("e_refin_ctrl", state_utils.RetrievalType.FIELD)

    hmask_dd3d_ref = metrics_savepoint.hmask_dd3d()
    hmask_dd3d_full = factory.get("hmask_dd3d", state_utils.RetrievalType.FIELD)
...
def test_factory_zdiff_gradp(
    ...
    zdiff_gradp_full_field = factory.get("zdiff_gradp", state_utils.RetrievalType.FIELD)
...
def test_factory_coeff_gradekin(
    ...
    factory.get("edge_cell_length", state_utils.RetrievalType.FIELD)
    factory.get("inv_dual_edge_length", state_utils.RetrievalType.FIELD)

    coeff_gradekin_ref = metrics_savepoint.coeff_gradekin()
    coeff_gradekin_full = factory.get("coeff_gradekin", state_utils.RetrievalType.FIELD)
...
def test_factory_diffusion(
    ...
    factory.get("height", state_utils.RetrievalType.FIELD)
    factory.get("max_nbhgt", state_utils.RetrievalType.FIELD)
    factory.get("c_owner_mask", state_utils.RetrievalType.FIELD)
    factory.get("maxslp_avg", state_utils.RetrievalType.FIELD)
    factory.get("maxhgtd_avg", state_utils.RetrievalType.FIELD)

    mask_hdiff = factory.get("mask_hdiff", state_utils.RetrievalType.FIELD)
    zd_diffcoef_dsl = factory.get("zd_diffcoef_dsl", state_utils.RetrievalType.FIELD)
    zd_vertoffset_dsl = factory.get("zd_vertoffset_dsl", state_utils.RetrievalType.FIELD)
    zd_intcoef_dsl = factory.get("zd_intcoef_dsl", state_utils.RetrievalType.FIELD)
