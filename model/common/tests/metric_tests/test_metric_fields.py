...
def test_compute_rayleigh_w(icon_grid, experiment, metrics_savepoint, grid_savepoint, backend):
    ...
    rayleigh_type = 2
    rayleigh_coeff = 0.1 if experiment == dt_utils.GLOBAL_EXPERIMENT__WIP else 5.0
    damping_height = 50000.0 if experiment == dt_utils.GLOBAL_EXPERIMENT__WIP else 12500.0
