...
from icon4py.model.testing import parallel_helpers, definitions as test_defs

from .. import utils
from ...fixtures import icon_grid, processor_props, grid_savepoint, data_provider, download_ser_data, ranked_data_path, backend
...
def test_distributed_local(
    processor_props: decomp_defs.ProcessProperties, dim: gtx.Dimension, icon_grid: base_grid.Grid, experiment:test_defs.Experiment
) -> None:
