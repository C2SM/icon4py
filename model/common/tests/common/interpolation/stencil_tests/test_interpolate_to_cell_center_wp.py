...
from icon4py.model.common.interpolation.stencils.interpolate_to_cell_center_wp import (
    interpolate_to_cell_center_wp,
)
from icon4py.model.common.states import utils as state_utils
from icon4py.model.testing import stencil_tests


def _interpolate_to_cell_center_numpy(
...
class TestInterpolateToCellCenterWp(stencil_tests.StencilTest):
    PROGRAM = interpolate_to_cell_center_wp
    ...
    def reference(
        ...
        **kwargs: Any,
        ...
        interpolation = _interpolate_to_cell_center_numpy(connectivities, interpolant, e_bln_c_s)
    ...
    def input_data(
        ...
        interpolation = data_alloc.zero_field(dims.CellDim, dims.KDim, dtype=ta.wpfloat)
