...
r04b09_dsl_grid_path = test_definitions.GRIDS_PATH.joinpath(test_definitions.Experiments.REGIONAL)
r04b09_dsl_data_file = r04b09_dsl_grid_path.joinpath("mch_ch_r04b09_dsl_grids_v1.tar.gz").name

r02b04_global_grid_path = test_definitions.GRIDS_PATH.joinpath(test_definitions.Experiments.R02B04)
