...
from icon4py.model.common.grid import base as grid_def, simple, vertical as v_grid
...
def initialized_writer(
    test_path, random_name, grid=simple_grid
...
def test_writer_append_timeslice_create_new_var(test_path, random_name):
    ...
    state = dict(air_density=test_utils.model_state(grid)["air_density"])
