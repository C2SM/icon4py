...
from icon4py.model.common.interpolation.interpolation_fields4 import (
    compute_c_bln_avg,
    compute_c_lin_e,
...
from icon4py.model.common.constants import EXNER_EXPOL
...
@pytest.mark.datatest
def test_compute_exner_exfac(grid_savepoint, interpolation_savepoint, metrics_savepoint, icon_grid):
    ddxn_z_full = metrics_savepoint.ddxn_z_full().asnumpy()
    ...
    exner_exfac_ref = metrics_savepoint.exner_exfac().asnumpy()
    exner_exfac = compute_exner_exfac(
        ddxn_z_full,
        dual_edge_length,
        EXNER_EXPOL,
        c2e,
    ...
    print(exner_exfac_ref)
    print(exner_exfac)
    assert np.allclose(exner_exfac, exner_exfac_ref)
