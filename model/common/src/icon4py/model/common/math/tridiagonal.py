...
"""Generic vertical tridiagonal (Thomas algorithm) solver scan operators.

Callers compose the two scans over the K dimension:

    c_prime, d_prime = _tridiagonal_forward_sweep(a, b, c, d)
    x = _tridiagonal_back_substitution(c_prime, d_prime)
"""
