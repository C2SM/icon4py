...
class VerticalGrid:
    ...
    def __post_init__(self, vct_a, vct_b):
        ...
        object.__setattr__(
            ...
            self._determine_start_level_of_moist_physics(xp.asarray(vct_a_array), self.config.htop_moist_proc),
        )
        object.__setattr__(
            self,
            "_end_index_of_flat_layer",
            self._determine_end_index_of_flat_layers(xp.asarray(vct_a_array), self.config.flat_height),
        )
