...
class CellParams:
    ...
    def from_global_num_cells(
        cls,
        cell_center_lat: fa.CfloatField,
        cell_center_lon: fa.CfloatField,
        area: fa.CfloatField,
