...
def compute_zdiff_gradp_dsl(
    ...
    horizontal_start = 428
    # None of the if statements get accessed
    for k in range(nlev):
        for e in range(horizontal_start):  # TODO: calculate horizontal_start, not hard coded
            if (
    ...
    for je in range(nedges):
        ...
        for jk in range(flat_idx[je], nlev):
