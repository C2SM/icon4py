...
def compute_ddqz_z_half(  # noqa: PLR0917
    z_ifc: fa.CellKField[wpfloat],
    z_mc: fa.CellKField[wpfloat],
...
def compute_ddqz_z_full_and_inverse(  # noqa: PLR0917
    z_ifc: fa.CellKField[wpfloat],
...
@gtx.program
def compute_scaling_factor_for_3d_divdamp(  # noqa: PLR0917
    vct_a: fa.KField[wpfloat],
...
@gtx.field_operator
def _compute_rayleigh_w(  # noqa: PLR0917
    vct_a: fa.KField[wpfloat],
...
@gtx.program
def compute_rayleigh_w(  # noqa: PLR0917
...
@gtx.program(grid_type=gtx.GridType.UNSTRUCTURED)
def compute_coeff_dwdz(  # noqa: PLR0917
    ddqz_z_full: fa.CellKField[wpfloat],
    z_ifc: fa.CellKField[wpfloat],
...
@gtx.program
def compute_ddxn_z_half_e(  # noqa: PLR0917
    z_ifc: fa.CellKField[wpfloat],
...
@gtx.program
def compute_ddxt_z_half_e(  # noqa: PLR0917
    cell_in: fa.CellKField[wpfloat],
    c_int: gtx.Field[gtx.Dims[dims.VertexDim, dims.V2CDim], wpfloat],
    inv_primal_edge_length: fa.EdgeField[wpfloat],
    tangent_orientation: fa.EdgeField[wpfloat],
...
@gtx.program
def compute_maxslp_maxhgtd(  # noqa: PLR0917
...
@gtx.program(grid_type=gtx.GridType.UNSTRUCTURED)
def compute_exner_exfac(  # noqa: PLR0917
    maxslp: fa.CellKField[wpfloat],
    maxhgtd: fa.CellKField[wpfloat],
...
@gtx.program
def compute_wgtfac_e(  # noqa: PLR0917
...
@gtx.field_operator
def _compute_pressure_gradient_downward_extrapolation_mask_distance(  # noqa: PLR0917
    z_mc: fa.CellKField[wpfloat],
...
@gtx.program(grid_type=gtx.GridType.UNSTRUCTURED)
def compute_pressure_gradient_downward_extrapolation_mask_distance(  # noqa: PLR0917
    z_mc: fa.CellKField[wpfloat],
    c_lin_e: gtx.Field[gtx.Dims[dims.EdgeDim, dims.E2CDim], float],
    topography: fa.CellField[wpfloat],
    e_owner_mask: fa.EdgeField[bool],
...
@gtx.program(grid_type=gtx.GridType.UNSTRUCTURED)
def compute_horizontal_mask_for_3d_divdamp(  # noqa: PLR0917
    e_refin_ctrl: fa.EdgeField[gtx.int32],
...
@gtx.program(grid_type=gtx.GridType.UNSTRUCTURED)
def compute_weighted_cell_neighbor_sum(  # noqa: PLR0917
    maxslp: gtx.Field[gtx.Dims[dims.CellDim, dims.KDim], wpfloat],
    maxhgtd: gtx.Field[gtx.Dims[dims.CellDim, dims.KDim], wpfloat],
    c_bln_avg: gtx.Field[gtx.Dims[dims.CellDim, C2E2CODim], wpfloat],
...
def _compute_param(  # noqa: PLR0917
