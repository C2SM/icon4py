...
C2CEC = gtx.FieldOffset("C2CEC", source=CECDim, target=(CellDim, C2E2CDim))
E2EC = gtx.FieldOffset("E2EC", source=ECDim, target=(EdgeDim, E2CDim))
E2ECV = gtx.FieldOffset("E2ECV", source=ECVDim, target=(EdgeDim, E2C2VDim))
