...
def _interpolate_to_cell_center_vp(
    ...
    Reduced precision variant; the working-precision one lives in
    :mod:`interpolate_to_cell_center_wp`. Formerly known as
    mo_velocity_advection_stencil_08 or mo_velocity_advection_stencil_09.
    """
