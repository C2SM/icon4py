...
def _mo_intp_rbf_rbf_vec_interpol_cell(
    ...
    ptr_coeff_1: gtx.Field[gtx.Dims[dims.CellDim, dims.C2EDim], wpfloat],
    ptr_coeff_2: gtx.Field[gtx.Dims[dims.CellDim, dims.C2EDim], wpfloat],
) -> tuple[fa.CellKField[wpfloat], fa.CellKField[wpfloat]]:
    p_u_out = neighbor_sum(ptr_coeff_1 * p_vn_in(C2E), axis=dims.C2EDim)
    p_v_out = neighbor_sum(ptr_coeff_2 * p_vn_in(C2E), axis=dims.C2EDim)
