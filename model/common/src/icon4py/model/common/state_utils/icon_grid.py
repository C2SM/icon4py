...
# TODO(tehrengruber): file temporary copied from https://raw.githubusercontent.com/C2SM/icon4py/implement_nhsolve/atm_dyn_iconam/src/icon4py/state_utils/icon_grid.py
...
from icon4py.model.common.state_utils.horizontal import HorizontalMeshSize
...
class IconGrid:
    ...
    def __getattr__(self, name: str):
        conn = self.connectivities[name.lower()]
        return conn
