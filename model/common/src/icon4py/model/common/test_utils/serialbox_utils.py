...
from icon4py.model.common.state_utils import icon_grid
#from icon4py.state_utils.diagnostic_state import DiagnosticState
from icon4py.model.common.state_utils.horizontal import (
    CellParams,
    EdgeParams,
    HorizontalMeshSize,
)
from icon4py.model.common.state_utils.icon_grid import IconGrid, MeshConfig, VerticalMeshConfig
...
# TODO(tehrengruber): copied from icon4py.diffusion.diffusion to avoid import
...
class IconGridSavePoint(IconSavepoint):
    ...
    # def e2c2eo(self):
    #     return self._get_connectiviy_array("e2c2eo")
    ...
    def nflatlev(self):
        return self._read_int32("nflatlev")
...
class InterpolationSavepoint(IconSavepoint):
    ...
    def pos_on_tplane_e(self):
        field = self._get_field("pos_on_tplane_e", EdgeDim, E2CDim)
    ...
    def construct_interpolation_state(self):  # -> InterpolationState:
        ...
        #     pos_on_tplane_e=self.pos_on_tplane_e(),
