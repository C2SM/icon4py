...
class MetricSavepoint(IconSavepoint):
    ...
    def cartesian_center_c_c_x(self):
        return self._get_field("cartesian_center_c_c_x", dims.C2EDim)

    def cartesian_center_c_c_y(self):
        return self._get_field("cartesian_center_c_c_y", dims.C2EDim)

    def cartesian_center_c_c_z(self):
        return self._get_field("cartesian_center_c_c_z", dims.C2EDim)

    def cartesian_center_e_c_x(self):
        return self._get_field("cartesian_center_e_c_x", dims.C2E2CDim)

    def cartesian_center_e_c_y(self):
        return self._get_field("cartesian_center_e_c_y", dims.C2E2CDim)

    def cartesian_center_e_c_z(self):
        return self._get_field("cartesian_center_e_c_z", dims.C2E2CDim)

    def primal_cart_normal_c_x(self):
        return self._get_field("primal_cart_normal_c_x", dims.C2E2CDim)

    def primal_cart_normal_c_y(self):
        return self._get_field("primal_cart_normal_c_y", dims.C2E2CDim)

    def primal_cart_normal_c_z(self):
        return self._get_field("primal_cart_normal_c_z", dims.C2E2CDim)

    def lat_c(self):
        return self._get_field("lat_c", dims.CellDim)

    def lon_c(self):
        return self._get_field("lon_c", dims.CellDim)

    def rbf_vec_idx_c_c(self):
        return self._get_field("rbf_vec_idx_c_c", dims.C2E2CDim, dims.CellDim)

    def z_dist_c(self):
        return self._get_field("z_dist_c", dims.CellDim)

    #"i_endidx_c": 0,
    #"i_startidx_c": 0,

    def z_diag_c(self):
        return self._get_field("z_diag_c", dims.CellDim, dims.C2E2CDim)

    def z_nx1_c(self):
        return self._get_field("z_nx1_c", dims.C2EDim, dims.C2E2CDim) # TODO: dimensions

    def z_nx2_c(self):
        return self._get_field("z_nx2_c", dims.CellDim, dims.C2E2CDim) # TODO: dimensions

    def z_rbfmat_c(self):
        return self._get_field("z_rbfmat_c", dims.CellDim, dims.C2E2CDim, dims.C2EDim) # TODO: dimensions

    def z_rbfval_c(self):
        return self._get_field("z_rbfval_c", dims.CellDim, dims.C2E2CDim) # TODO: dimensions

    def z_rhs1_c(self):
        return self._get_field("z_rhs1_c", dims.CellDim, dims.C2E2CDim) # TODO: dimensions

    def z_rhs2_c(self):
        return self._get_field("z_rhs2_c", dims.CellDim, dims.C2E2CDim) # TODO: dimensions

    def i_startidx_c(self):
        return self.serializer.read("i_startidx_c", self.savepoint)[0]

    def i_endidx_c(self):
        return self.serializer.read("i_endidx_c", self.savepoint)[0]
