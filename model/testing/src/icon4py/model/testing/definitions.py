...
class Grids:
    ...
    TORUS_200X232_500M: Final = GridDescription(
        name="torus_100000mx100000m_res500m",
        description="Torus grid with a domain (100_000 m x 100_000 m) and an equivalent resolution of 500 m, generated by MPI-M GridGenerator",
        params=icon_grid.GridParams(
            icon_grid.TorusParams(
                domain_length=100000.0,
                domain_height=100458.946838995,
            ),
        ),
    )
    TORUS_400X462_250M: Final = GridDescription(
        name="torus_100000mx100000m_res250m",
        description="Torus grid with a domain (100_000 m x 100_000 m) and an equivalent resolution of 250 m, generated by MPI-M GridGenerator",
        params=icon_grid.GridParams(
            icon_grid.TorusParams(
                domain_length=100000.0,
                domain_height=100025.934137103,
            ),
        ),
    )
