...
class Grids:
    ...
    R02B04_GLOBAL: Final = GridDescription(
        ...
        description=(
            "R02B04, small global grid, default grid used in ICON testing. Origin is a "
            "DWD grid: the file carries centre=78 (Offenbach), subcentre=255 and "
            "history='/e/uhome/dreinert/icon/build/sx9', i.e. generated by D. Reinert on "
            "an NEC SX9. uuidOfHGrid af122aca-1dd2-11b2-a7f8-c7bf6bc21eba. NOTE: it is a "
            "different mesh from the MPI-M R02B04_GLOBAL_MPIM below despite the identical "
            "cell count, and no land boundary data is published against it."
        ),
        params=icon_grid.GridParams(
            icon_grid.IcosahedronParams(
...
class Experiments:
    ...
    EXCLAIM_APE_AES: Final = ExperimentDescription(
        ...
        # The MPI-M grid, not the DWD one the other idealized experiments use: the
        # published ICON-Land boundary data exists only for this mesh.
        grid=Grids.R02B04_GLOBAL_MPIM,
        version=11,
    )
