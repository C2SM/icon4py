...
class Grids:
    R02B04_GLOBAL: Final = GridDescription(
        ...
        archive_name="icon_grid_0013_R02B04_R.nc.tar.gz",
    ...
    R02B07_GLOBAL: Final = GridDescription(
        ...
        archive_name="icon_grid_0023_R02B07_G.nc.tar.gz",
    ...
    R02B06_GLOBAL: Final = GridDescription(
        ...
        archive_name="icon_grid_0021_R02B06_G.nc.tar.gz",
    ...
    R19_B07_MCH_LOCAL: Final = GridDescription(
        ...
        archive_name="icon_grid_0002_R19B07_mch.nc.tar.gz",
    ...
    MCH_OPR_R04B07_DOMAIN01: Final = GridDescription(
        ...
        archive_name="mch_opr_r4b7_DOM01.nc.tar.gz",
    ...
    MCH_OPR_R19B08_DOMAIN01: Final = GridDescription(
        ...
        archive_name="domain1_DOM01.nc.tar.gz",
    ...
    MCH_CH_R04B09_DSL: Final = GridDescription(
        ...
        kind=GridKind.REGIONAL,
        file_name="grid.nc",
        archive_name="mch_ch_r04b09_dsl_grids_v1.tgz",
    ...
    TORUS_100X116_1000M: Final = GridDescription(
        ...
        description="Torus grid with a domain (100x116) vertices and a edge length of 1000m, generated by MPI-M GridGenerator ",
        sizes={"cell": 23200, "vertex": 11600, "edge": 34800},
        kind=GridKind.TORUS,
        file_name="Torus_Triangles_100x116_1000m.nc",
        archive_name="Torus_Triangles_100x116_1000m.nc.tar.gz",
    ...
    TORUS_50000x5000: Final = GridDescription(
        ...
        description="Torus grid with a edge_length of 757m, generated by MPI-M GridGenerator",
        sizes={"cell": 1056, "vertex": 52, "edge": 1584},
        kind=GridKind.TORUS,
        file_name="Torus_Triangles_50000m_x_5000m_res500m.nc",
        archive_name="Torus_Triangles_50000m_x_5000m_res500m.nc.tar.gz",
