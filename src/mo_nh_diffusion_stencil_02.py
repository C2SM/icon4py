...
def mo_nh_diffusion_stencil_div_gt4py(
    ...
    out_field = np_as_located_field(CellDim)(np.zeros(shape=(18,)))
    ...
    exec_stencil(
        vn_field, geofac_div_field, out_field, offset_provider={"C2E": C2E_offset_provider}
    )
    return out_field
...
def mo_nh_diffusion_stencil_kh_c_gt4py(
    ...
    exec_stencil(kh_smag_ec_field, e_bln_c_s_field, diff_multfac_smag_field, out_field, offset_provider={"C2E": C2E_offset_provider})
