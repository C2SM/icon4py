...
from icon4py.common.dimension import KDim, CellDim, C2E2CDim, C2EDim, V2EDim, VertexDim, C2E2CODim, \
    EdgeDim, ECVDim
...
from icon4py.diffusion.horizontal import EdgeParams, CellParams
...
def diffusion_init(vct_a:Field[[KDim], float],
    ...
    edges_params = EdgeParams(tangent_orientation=tangent_orientation,
    ...
    metric_state = MetricState(theta_ref_mc, wgtfac_c, mask_hdiff, zd_vertidx, zd_diffcoef, zd_intcoef)
    interpolation_state = InterpolationState(e_bln_c_s,
                                             rbf_coeff_1,
                                             rbf_coeff_2,
                                             geofac_div ,
                                             geofac_n2s,
