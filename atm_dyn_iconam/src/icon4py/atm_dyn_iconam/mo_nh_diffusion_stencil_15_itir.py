...
@fundef
def _mo_nh_diffusion_stencil_15_itir(
    mask,
    zd_vertoffset,
    zd_diffcoef,
    geofac_n2s_c,
...
@fendef
def mo_nh_diffusion_stencil_15_itir(
    mask,
    zd_vertoffset,
    zd_diffcoef,
    geofac_n2s_c,
    ...
    closure(
        ...
        _mo_nh_diffusion_stencil_15_itir,
        z_temp,
        [
            mask,
            zd_vertoffset,
...
mo_nh_diffusion_stencil_15_itir.__dict__["offsets"] = [
    Koff.value,
    C2E2C.value,
]  # could be done with a pass...
mo_nh_diffusion_stencil_15_itir.__dict__["metadata"] = _metadata
