...
def _mo_intp_rbf_rbf_vec_interpol_vertex_dom_a_p_u(
    p_e_in: Field[[EdgeDim, KDim], float32],
    ptr_coeff_1: Field[[VertexDim, V2EDim], float32],
...
def mo_intp_rbf_rbf_vec_interpol_vertex_dom_a_p_u(
    p_e_in: Field[[EdgeDim, KDim], float32],
    ptr_coeff_1: Field[[VertexDim, V2EDim], float32],
    p_u_out: Field[[VertexDim, KDim], float32],
):
...
def _mo_intp_rbf_rbf_vec_interpol_vertex_dom_a_p_v(
    p_e_in: Field[[EdgeDim, KDim], float32],
    ptr_coeff_2: Field[[VertexDim, V2EDim], float32],
) -> Field[[VertexDim, KDim], float32]:
...
def mo_intp_rbf_rbf_vec_interpol_vertex_dom_a_p_v(
    p_e_in: Field[[EdgeDim, KDim], float32],
    ptr_coeff_2: Field[[VertexDim, V2EDim], float32],
    p_v_out: Field[[VertexDim, KDim], float32],
):
