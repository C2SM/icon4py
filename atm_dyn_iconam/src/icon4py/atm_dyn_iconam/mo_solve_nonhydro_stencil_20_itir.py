...
@fundef
def _mo_solve_nonhydro_stencil_20_itir(
...
@fendef
def mo_solve_nonhydro_stencil_20_itir(
    inv_dual_edge_length,
    z_exner_ex_pr,
    zdiff_gradp,
    ikoffset,
    ...
    closure(
        ...
        _mo_solve_nonhydro_stencil_20_itir,
        z_gradh_exner,
        [
            inv_dual_edge_length,
            z_exner_ex_pr,
...
mo_solve_nonhydro_stencil_20_itir.__dict__["offsets"] = [
    Koff.value,
    E2C.value,
]  # could be done with a pass...
mo_solve_nonhydro_stencil_20_itir.__dict__["metadata"] = _metadata
