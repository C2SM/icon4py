...
from icon4py.atm_dyn_iconam.mo_nh_diffusion_stencil_16 import _mo_nh_diffusion_stencil_16
from icon4py.common.dimension import CellDim, KDim, EdgeDim, C2E2CDim, C2EDim, V2EDim, VertexDim, \
    C2E2CODim, ECVDim
...
def diffusion_run(
    ...
    _fused_mo_nh_diffusion_stencil_02_03(
        ...
        domain={CellDim:(cell_startindex_nudging, cell_endindex_local),
                KDim: (0, nlev)}
    ...
    _mo_intp_rbf_rbf_vec_interpol_vertex(
        ...
        interpolation_rbf_coeff_2,
        out = (local_u_vert,local_v_vert),
        domain={VertexDim:(vertex_startindex_lb_plus3, vertex_endindex_local),
                KDim: (0, nlev)
                }
