...
def _mo_velocity_advection_stencil_07(
    ...
    return vn_ie*inv_dual_edge_length*(w(E2C[0]) - w(E2C[1])) + \
...
def mo_velocity_advection_stencil_07(
    ...
    _mo_velocity_advection_stencil_07(vn_ie, inv_dual_edge_length, w, z_vt_ie, 
            inv_primal_edge_length, tangent_orientation, z_w_v, out=z_v_grad_w)
