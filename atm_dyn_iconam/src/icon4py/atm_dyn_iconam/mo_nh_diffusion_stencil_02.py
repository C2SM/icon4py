...
def _mo_nh_diffusion_stencil_02_khc(
    ...
    return _mo_nh_diffusion_stencil_02(
...
def mo_nh_diffusion_stencil_02(
    ...
    _mo_nh_diffusion_stencil_02_khc(
        kh_smag_ec, vn, e_bln_c_s, geofac_div, diff_multfac_smag, out=kh_c
    )
    _mo_nh_diffusion_stencil_02_div(
        kh_smag_ec, vn, e_bln_c_s, geofac_div, diff_multfac_smag, out=div
    )
