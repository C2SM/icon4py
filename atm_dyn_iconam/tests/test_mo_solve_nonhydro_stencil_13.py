...
def mo_solve_nonhydro_stencil_13_z_rth_pr_1_numpy(
    rho: np.array, rho_ref_mc: np.array
) -> np.array:
    z_rth_pr_1 = rho - rho_ref_mc
    return z_rth_pr_1


def mo_solve_nonhydro_stencil_13_z_rth_pr_2_numpy(
    theta_v: np.array, theta_ref_mc: np.array
) -> np.array:
...
def mo_solve_nonhydro_stencil_13_numpy(
    ...
    z_rth_pr_1 = mo_solve_nonhydro_stencil_13_z_rth_pr_1_numpy(rho, rho_ref_mc)
    z_rth_pr_2 = mo_solve_nonhydro_stencil_13_z_rth_pr_2_numpy(theta_v, theta_ref_mc)
