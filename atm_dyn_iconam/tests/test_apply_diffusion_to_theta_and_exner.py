...
from icon4py.atm_dyn_iconam.apply_diffusion_to_theta_and_exner import apply_diffusion_to_theta_and_exner
from icon4py.common.dimension import CellDim, EdgeDim, CEDim, CECDim, C2E2CDim, KDim

from .test_utils.helpers import flatten_first_two_dims, random_field, random_mask, zero_field
