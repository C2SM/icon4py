...
from icon4py.atm_dyn_iconam.calculate_nabla_of_theta import (
    calculate_nabla_of_theta,
)
...
def calculate_nabla_of_theta_numpy(
...
def test_calculate_nabla_of_theta():
    mesh = SimpleMesh()
    ...
    ref = calculate_nabla_of_theta_numpy(
