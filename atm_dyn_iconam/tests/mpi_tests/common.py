...
base_path = Path(__file__).parent.parent.parent.parent.joinpath(
    f"testdata/ser_icondata/mpitask{props.comm_size}/"
)
data_path = base_path.joinpath("mch_ch_r04b09_dsl/ser_data")
data_uris = {
