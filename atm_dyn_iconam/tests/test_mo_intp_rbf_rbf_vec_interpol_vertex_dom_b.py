...
from icon4py.atm_dyn_iconam.mo_intp_rbf_rbf_vec_interpol_vertex_dom_b import (
    mo_intp_rbf_rbf_vec_interpol_vertex_dom_b,
)
...
def mo_intp_rbf_rbf_vec_interpol_vertex_dom_b_p_v_numpy(
    v2e: np.array,
    p_e_in: np.array,
...
def mo_intp_rbf_rbf_vec_interpol_vertex_dom_b_p_u_numpy(
    v2e: np.array,
    p_e_in: np.array,
...
def mo_intp_rbf_rbf_vec_interpol_vertex_dom_b_numpy(
    v2e: np.array,
    p_e_in: np.array,
    ptr_coeff_1: np.array,
    ptr_coeff_2: np.array,
    ...
    p_u_out = mo_intp_rbf_rbf_vec_interpol_vertex_dom_b_p_u_numpy(
        v2e, p_e_in, ptr_coeff_2
    )
    return p_v_out, p_u_out


def test_mo_intp_rbf_rbf_vec_interpol_vertex_dom_b():
    mesh = SimpleMesh()
    ...
    p_v_out_ref, p_u_out_ref = mo_intp_rbf_rbf_vec_interpol_vertex_dom_b_numpy(
        mesh.v2e,
        np.asarray(p_e_in),
        np.asarray(ptr_coeff_1),
        np.asarray(ptr_coeff_2),
    )
