...
- a `<component>` folder with a **unique name** in this repository for the package being tested (e.g. `atmosphere-tracer_advection` for the `icon4py.model.atmosphere.tracer_advection` component).
