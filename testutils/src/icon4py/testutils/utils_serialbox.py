...
def field_test(
    ...
    if ref.ndim == 3:
        ...
        ref = ref.swapaxes(1, 2).reshape(shape_2D)[15:16, :]  # DL: Debug single column
        ...
        ref = np.broadcast_to(ref, shape_2D)[15:16, :]

    try:
        # np.testing.assert_allclose(fld, ref, atol=atol, rtol=rtol, verbose=False) # DL: Debug single column
