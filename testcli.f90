...
#define __ENABLE_DDT_VN_XYZ__
  ...
  !!
    ...
    !$ser init directory="." prefix="f2ser" mpi_rank=get_my_mpi_work_id()
  ...
  SUBROUTINE  diffusion_run(jg, dtime, linit,                              &
    ...
    PRINT *, 'Serializing linit=linit'

    !$ser data linit=linit

    PRINT *, 'Serializing vt=vt(:,:,:)'
    ...
    PRINT *, 'Serializing theta_v=theta_v(:,:,:)'
    ...
    PRINT *, 'Serializing theta_v_ic=theta_v_ic(:,:,:)'
    ...
    PRINT *, 'Serializing ddt_vn_dyn=ddt_vn_dyn(:,:,:)'
    ...
    PRINT *, 'Serializing ddt_vn_hdf=ddt_vn_hdf(:,:,:)'
...
!$OMP END PARALLEL
    ...
    PRINT *, 'Serializing div_ic=div_ic(:,:,:)'
    ...
    PRINT *, 'Serializing hdef_ic=hdef_ic(:,:,:)'
