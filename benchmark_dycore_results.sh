...
export GT4PY_BUILD_CACHE_DIR_PREFIX="GH200_dycore_workspace_128x2_256x1_${SUFFIX}"
...
echo "Executing dycore on ${SLURM_NNODES} GH200 nodes to check the WALL CLOCK timer reported at the end of the run"
