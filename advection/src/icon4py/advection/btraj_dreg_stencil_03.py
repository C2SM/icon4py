...
def btraj_dreg_stencil_03(
    ...
    p_coords_dreg_v_1_lon: Field[[EdgeDim, KDim], float],
    p_coords_dreg_v_2_lon: Field[[EdgeDim, KDim], float],
    p_coords_dreg_v_3_lon: Field[[EdgeDim, KDim], float],
    p_coords_dreg_v_4_lon: Field[[EdgeDim, KDim], float],
    p_coords_dreg_v_1_lat: Field[[EdgeDim, KDim], float],
