...
from icon4py.common.dimension import CellDim, Koff, KDim
...
def _vert_adv_stencil_01(
    ...
    tracer_new = ( tracer_now * rhodz_now + p_dtime * ( p_mflx_tracer_v(Koff[1]) * deepatmo_divzl - p_mflx_tracer_v * deepatmo_divzu ) ) / rhodz_new
