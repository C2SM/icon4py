...
from icon4py.common.dimension import CellDim, KDim, EdgeDim, E2C
...
def _upwind_hflux_miura_cycl_stencil_01(
	...
	z_tracer_mflx_dsl = ( where(cell_rel_idx_dsl == int32(1), z_lsq_coeff_1_dsl(E2C[1]), z_lsq_coeff_1_dsl(E2C[0])) 
             + distv_bary_1 * where(cell_rel_idx_dsl == int32(1), z_lsq_coeff_2_dsl(E2C[1]), z_lsq_coeff_2_dsl(E2C[0]))
             + distv_bary_2 * where(cell_rel_idx_dsl == int32(1), z_lsq_coeff_3_dsl(E2C[1]), z_lsq_coeff_3_dsl(E2C[0]))
             ) * p_mass_flx_e
