...
def test_dycore_wrapper_granule_inputs(  # noqa: PLR0917
...
def test_granule_solve_nonhydro_single_step_regional(  # noqa: PLR0917
    grid_init,  # initializes the grid as side-effect
...
@pytest.mark.parametrize("backend", [None])  # TODO(havogt): consider parametrizing over backends
def test_granule_solve_nonhydro_multi_step_regional(  # noqa: PLR0917
    grid_init,  # initializes the grid as side-effect
    solve_nh_init,  # initializes solve_nh as side-effect
    step_date_init,
    step_date_exit,
