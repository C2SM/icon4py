...
extern int grid_init_wrapper(
    ...
    int primal_normal_y_size_0, double *vct_a, int vct_a_size_0,
...
extern int solve_nh_init_wrapper(
    ...
    int zdiff_gradp_size_1, int zdiff_gradp_size_2, int *vertidx_gradp,
    int vertidx_gradp_size_0, int vertidx_gradp_size_1,
    int vertidx_gradp_size_2, int *pg_edgeidx, int pg_edgeidx_size_0,
    int *pg_vertidx, int pg_vertidx_size_0, double *pg_exdist,
    int pg_exdist_size_0, double *ddqz_z_full_e, int ddqz_z_full_e_size_0,
